...
public class Messages extends NLS {
    ...
    public static String EXTDOC_OVERRIDES_DESCRIPTION;
    public static String EXTDOC_OVERRIDES_OVERRIDE;
    public static String EXTDOC_OVERRIDES_OVERRIDES;
    public static String EXTDOC_OVERRIDES_DESCRIPTION_PATTERN;
    ...
    public static String EXTDOC_SELFCALLS_DESCRIPTION_IMPLEMENTORS;
    public static String EXTDOC_SELFCALLS_DESCRIPTION_SUBCLASSES;
    ...
    public static String EXTDOC_JAVADOC_NO_JAVADOC_FOUND;
    static {
