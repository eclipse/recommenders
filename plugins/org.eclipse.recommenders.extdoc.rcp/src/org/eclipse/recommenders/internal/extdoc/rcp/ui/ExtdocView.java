...
public class ExtdocView extends ViewPart {
	...
	final DragSourceListener dragSourceListener = new DragSourceListener() {
	    ...
	    @Override
	    public void dragStart(final DragSourceEvent event) {} // nothing to do here....
	    ...
	    @Override
	    public void dragFinished(final DragSourceEvent event) {} // nothing to do here....
	};	
	viewer.addDragSupport(operations, transferTypes, dragSourceListener);

	final DropTargetListener dropTargetListener = new ViewerDropAdapter(viewer) {
		...
		oldIndex = providers.indexOf(provider);	
	...
	viewer.addDropSupport(operations, transferTypes, dropTargetListener );
    }
