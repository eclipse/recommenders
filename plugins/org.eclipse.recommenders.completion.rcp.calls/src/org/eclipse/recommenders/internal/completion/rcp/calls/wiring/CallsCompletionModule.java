...
public class CallsCompletionModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(File.class).annotatedWith(CallsCompletion.class).toInstance(index);
        ...
        bind(IPreferenceStore.class).annotatedWith(CallsCompletion.class).toInstance(prefStore);
    }

    @BindingAnnotation
    @Target({ PARAMETER, METHOD })
    @Retention(RUNTIME)
    public static @interface CallsCompletion {
    }
