    ...
    private final class CallRecommendationsRenderer implements Runnable {
        ...
        public void run() {
            ...
            if (methodCalls.isEmpty()) {
                preamble2.setText(format(Messages.EXTDOC_RECOMMENDATIONS_ARE_NOT_MADE,
                        receiverType.getElementName(),
                        varName));
            } else {
                preamble2.setText(format(Messages.EXTDOC_RECOMMENDATIONS_ARE_MADE,
                                receiverType.getElementName(),
                                varName));
            }
            ...
            if (ctx == VmMethodName.NULL){
                text = format(Messages.EXTDOC_PROPOSAL_COMPUTED_UNTRAINED,
                        receiverType.getElementName());
            }else{
                text = format(Messages.EXTDOC_PROPOSAL_COMPUTED,
                        receiverType.getElementName(),
