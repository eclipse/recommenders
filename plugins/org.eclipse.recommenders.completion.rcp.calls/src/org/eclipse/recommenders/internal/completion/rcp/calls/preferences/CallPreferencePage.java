...
public class CallPreferencePage extends PreferencePage implements IWorkbenchPreferencePage, IPropertyChangeListener {
    ...
    public void init(final IWorkbench workbench) {
        ...
        setDescription(Messages.CallPreferencePage_2);
    }
    ...
    private void createConfigurationBlock(final Composite composite) {
        enablement = new ContentAssistEnablementBlock(composite, Messages.CallPreferencePage_3,
        ...
        maxProposals = createIntegerField(group, ID_MAX_PROPOSALS, Messages.CallPreferencePage_4, 1, 100);
        minProbability = createIntegerField(group, ID_MIN_PROBABILITY, Messages.CallPreferencePage_5, 1, 100);
    }
    ...
    private void createModelInformationBlock(final Composite composite) {
        new Label(composite, SWT.NONE)
                .setText(Messages.CallPreferencePage_6
                        + Messages.CallPreferencePage_7);
        computeMappings();
    ...
    private void createDetails(final SashForm form) {
        ...
        final GridDataFactory f = GridDataFactory.fillDefaults().grab(true, false);
        {
            ...
            rootContainer.setText(Messages.CallPreferencePage_8);
            rootContainer.setLayout(new GridLayout(2, false));
            rootContainer.setLayoutData(f.create());

            createLabel(rootContainer, Messages.CallPreferencePage_9);
            rootName = createText(rootContainer, READ_ONLY | BORDER);

            createLabel(rootContainer, Messages.CallPreferencePage_10);
            rootVersion = createText(rootContainer, READ_ONLY | BORDER);

            createLabel(rootContainer, Messages.CallPreferencePage_11);
        ...
        }
        {
            ...
            modelContainer.setText(Messages.CallPreferencePage_12);
            modelContainer.setLayout(new GridLayout(2, false));
            modelContainer.setLayoutData(f.create());

            createLabel(modelContainer, Messages.CallPreferencePage_13);
            modelCoordinate = createText(modelContainer, SWT.BORDER);

            createLabel(modelContainer, Messages.CallPreferencePage_14);
    ...
    private void createTable(final Composite container) {
        ...
        TableViewerColumn column = createTableViewerColumn(tableViewer, Messages.CallPreferencePage_19, 200, 0);
