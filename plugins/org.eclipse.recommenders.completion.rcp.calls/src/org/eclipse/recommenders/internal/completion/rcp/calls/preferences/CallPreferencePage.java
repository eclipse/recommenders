...
import org.eclipse.recommenders.utils.rcp.internal.AbstractEnablementPreferencePage;
...
public class CallPreferencePage extends AbstractEnablementPreferencePage {
    ...
    private StringFieldEditor maxProposals;
    private StringFieldEditor minProbability;
    ...
    public void init(final IWorkbench workbench) {
        ...
        setDescription("The calls content assist proposes method calls based on usage models of APIs.");
    }
    ...
    private void createConfigurationBlock(final Composite composite) {
        createEnablementButton(composite, "Enable Calls Proposals.");
        ...
        minProbability = createIntegerField(group, ID_MIN_PROBABILITY, "Minimum proposals probability (%):", 1, 100);
    }

    @Override
    protected void additionalExcludedCompletionCategoriesUpdates(final boolean isEnabled, final Set<String> cats) {
        // TODO: Is there something to respond to like JDT and Mylyn for subwords?
    }

    @Override
    protected String getCategoryId() {
        return CallsCompletionProposalComputer.CATEGORY_ID;
    }
