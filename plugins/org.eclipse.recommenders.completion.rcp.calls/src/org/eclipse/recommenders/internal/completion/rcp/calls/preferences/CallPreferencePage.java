...
import org.eclipse.recommenders.utils.rcp.internal.ContentAssistEnablmentBlock;
...
public class CallPreferencePage extends PreferencePage implements IWorkbenchPreferencePage, IPropertyChangeListener {
    ...
    private ContentAssistEnablmentBlock enablement;
    ...
    private void createConfigurationBlock(final Composite composite) {
        enablement = new ContentAssistEnablmentBlock(composite, "Enable Calls Proposals.",
