...
import org.eclipse.recommenders.internal.completion.rcp.calls.wiring.CallsCompletionModule.CallsCompletion;
...
public class ManualModelStoreWiring {
    ...
    static class CallModelArchiveStore extends DefaultModelArchiveStore<IType, IObjectMethodCallsNet> {
        ...
        @Inject
        public CallModelArchiveStore(@CallsCompletion File store, final IModelRepository repository,
