 ...
 * may return the <b>same</b> {@link ClassOverridePatterns} independent of whether {@link #releaseModel(ClassOverridePatterns)} was called or
 * not. Thus, these <b>models should not be shared between and used by several recommenders at the same time</b>.
 */
public class SingleZipOverridePatternModelProvider implements IModelProvider<IUniqueName<ITypeName>, ClassOverridePatterns>, Openable {

    private final File models;
    private ZipFile zip;

    public SingleZipOverridePatternModelProvider(File models) {
        this.models = models;
    }
