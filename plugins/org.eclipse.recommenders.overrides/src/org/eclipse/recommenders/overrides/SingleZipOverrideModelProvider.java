 ...
 * <p>
 * Note that this provider does not implement any pooling behavior, i.e., calls to {@link #acquireModel(QualifiedTypeName)}
...
public class SingleZipOverrideModelProvider implements IOverrideModelProvider, Openable {
    ...
    @Override
    public Optional<IOverrideModel> acquireModel(IQualifiedName<ITypeName> key) {
        try {
