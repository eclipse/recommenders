...
public class PoolingOverrideModelProvider extends PoolingModelProvider<IQualifiedName<ITypeName>, IOverrideModel> implements
    ...
    @Override
    protected Optional<IOverrideModel> loadModel(ZipFile zip, IQualifiedName<ITypeName> key) throws Exception {
