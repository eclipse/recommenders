...
public final class ChainCompletionProposal implements IJavaCompletionProposal, ICompletionProposalExtension2,
    ...
    ChainCompletionProposal(final TemplateProposal completion, final List<MemberEdge> chain) {
