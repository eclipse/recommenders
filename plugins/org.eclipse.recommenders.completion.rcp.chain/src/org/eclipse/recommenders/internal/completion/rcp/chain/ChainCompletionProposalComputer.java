...
public class ChainCompletionProposalComputer implements IJavaCompletionProposalComputer {
    ...
    private boolean findEntrypoints() {
        ...
        try {
            final Field field = InternalCompletionContext.class.getDeclaredField("extendedContext");
            field.setAccessible(true);
            final InternalExtendedCompletionContext extended = (InternalExtendedCompletionContext) field.get(context);
            final Field field2 = extended.getClass().getDeclaredField("assistScope");
            field2.setAccessible(true);
            scope = (Scope) field2.get(extended);
