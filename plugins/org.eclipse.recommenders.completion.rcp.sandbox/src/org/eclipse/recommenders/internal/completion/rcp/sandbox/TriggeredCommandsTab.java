...
import static org.eclipse.recommenders.internal.completion.rcp.sandbox.TableViewerFactory.createColumn;
import static org.eclipse.recommenders.internal.completion.rcp.sandbox.TableViewerFactory.createTableColumnLayout;
import static org.eclipse.recommenders.internal.completion.rcp.sandbox.TableViewerFactory.createTableViewer;
...
public class TriggeredCommandsTab {
    ...
    private int getTriggeredCommandsSize(Collection<TriggeredCommand> model) {
        int counter = 0;
        for (TriggeredCommand triggeredCommand : model) {
            counter += triggeredCommand.count;
        }
        return counter;
    }
