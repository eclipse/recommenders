...
import static org.eclipse.recommenders.stats.rcp.TableSorters.setCommandCountSorter;
import static org.eclipse.recommenders.stats.rcp.TableSorters.setCommandID;
import static org.eclipse.recommenders.stats.rcp.TableSorters.setCommandNameSorter;
...
public class TriggeredCommandsView {
    ...
    public void createContent(Composite masterComposite) {
        final Collection<TriggeredCommandObject> model = loadModelFromWorkspace();
        new Label(masterComposite, SWT.NONE).setText("Number of times commands triggered: "
                + getTriggeredCommandsSize(model));

        final Composite comp = new Composite(masterComposite, SWT.NONE);
