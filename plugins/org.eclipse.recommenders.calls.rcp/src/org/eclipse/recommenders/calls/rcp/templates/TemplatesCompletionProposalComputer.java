...
import org.eclipse.recommenders.calls.rcp.AstCallCompletionAnalyzer;
import org.eclipse.recommenders.completion.rcp.utils.DisableContentAssistCategoryJob;
import org.eclipse.recommenders.completion.rcp.utils.IRecommendersCompletionContext;
import org.eclipse.recommenders.completion.rcp.utils.RecommendersCompletionContext;
...
public class TemplatesCompletionProposalComputer implements IJavaCompletionProposalComputer {
    ...
    private ProjectCoordinateProvider pcp;
    ...
    @Inject
    public TemplatesCompletionProposalComputer(final ProjectCoordinateProvider projectCoordinateProvider,
    ...
    private List<Recommendation<String>> getMostLikelyPatternsSortedByProbability(final ICallModel net) {
        return Recommendations.top(net.recommendPatterns(), 20);
    }
    ...
    private Optional<IType> getSupertypeOfThis() {
        try {
            ...
            RecommendersUtilsPlugin.logError(e, "Failed to resolve super type of %s", rCtx.getEnclosingElement());
            return Optional.absent();
        }
    }
