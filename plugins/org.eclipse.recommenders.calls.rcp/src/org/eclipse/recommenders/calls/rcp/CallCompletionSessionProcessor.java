...
public class CallCompletionSessionProcessor extends SessionProcessor {
    ...
    private void updatePreferences() {
        IPreferenceStore s = CallsCompletionPlugin.getDefault().getPreferenceStore();
        prefMaxNumberOfProposals = 10;// s.getInt(P_MAX_NUMBER_OF_PROPOSALS);
        prefMinProposalProbability = 0.01;// s.getInt(P_MIN_PROPOSAL_PROBABILITY);
        prefUpdateProposalRelevance = true;// s.getBoolean(P_UPDATE_PROPOSAL_RELEVANCE);
        prefDecorateProposalText = true;// s.getBoolean(P_DECORATE_PROPOSAL_TEXT);
