...
public class TemplateBuilder {
    ...
    public TemplateBuilder appendStatement(String id, String commandId, Iterable<String> values) {
     ...
     * @return
     */
    private TemplateBuilder appendStatement(String id, String commandId, ITypeName... types) {
        return appendStatement(id, commandId, toLiterals(types));
    }
     ...
     * @return
     */
    private TemplateBuilder appendStatement(String id, String commandId, String value) {
        builder.append("${").append(id).append(":").append(commandId).append("(").append(value).append(")}");
        return this;
    }

    public TemplateBuilder appendStatement(String id, String commandId, String... values) {
        return appendStatement(id, commandId, Arrays.asList(values));
    }
    ...
    public TemplateBuilder argType(String id, String variable, int n) {
        return appendStatement(id, "argType", variable, String.valueOf(n));
    }
    ...
    public TemplateBuilder elemType(String id, String variable) {
        return appendStatement(id, "elemType", variable);
    }
    ...
    public TemplateBuilder field(String id, ITypeName... types) {
        return appendStatement(id, "field", types);
    }
    ...
    public TemplateBuilder imports(String id, ITypeName... types) {
        return appendStatement(id, "import", types);
    }
    ...
    public TemplateBuilder link(String id, String... proposals) {
        return appendStatement(id, "link", proposals);
    }
    ...
    public TemplateBuilder localVar(String id, ITypeName... types) {
        return appendStatement(id, "localVar", types);
    }
     ...
     */
    public TemplateBuilder newName(String id, String reference) {
        return appendStatement(id, "newName", reference);
    }

    public TemplateBuilder newType(String id, ITypeName type) {
        return appendStatement(id, "newType", toLiteral(type));
    }
    ...
    public String suggestId(IMethodName method) {
        ...
        varName += argumentCounter.add(varName, 1) == 0 ? "" : argumentCounter.count(varName) - 1;
        return varName;
    }
    ...
    public TemplateBuilder var(String id, ITypeName... types) {
        return appendStatement(id, "var", types);
    }
