...
public final class TypoSessionProcessor extends SessionProcessor {
    ...
    @Inject
    public TypoSessionProcessor(IAstProvider astProvider) {
    ...
    public void process(final IProcessableProposal proposal) throws JavaModelException {
        ...
        final String completion = getTokensBetweenLastWhitespaceAndFirstOpeningBracket(proposal.getDisplayString())
                .toLowerCase();
