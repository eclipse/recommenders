 ...
 */
package org.eclipse.recommenders.jayes.rcp;
...
public class JayesEditor extends EditorPart {
    ...
    private TreeViewerColumn createNameColumn(Tree tree, MyViewerSorter sorter) {
    ...
    private TreeViewerColumn createValueColumn(Tree tree, MyViewerSorter sorter) {
