...
public class LocalSearchThread extends Thread {
	...
	public LocalSearchThread(LocalMatchClient client, MatchEnvironment env,
			String query, ISearchListener listener) {
	...
	public void run() {
		...
		if (resultList == null) listener.searchFailed("No snippets match for " + query);
		else{
