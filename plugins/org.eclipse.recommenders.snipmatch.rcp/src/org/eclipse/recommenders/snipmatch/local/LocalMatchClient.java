...
public final class LocalMatchClient implements SearchClient{
	...
	@Override
	public void startSearch(String query, MatchEnvironment env,
	...
	public void cancelWork() {
		...
		if (isWorking()) workThread.cancel();
	}
	...
	@Override
	public void startSendFeedback(String query, MatchNode result,
			String comment, int rating, boolean flag, boolean isLog,
			boolean isStartup, long clientId, boolean used,
