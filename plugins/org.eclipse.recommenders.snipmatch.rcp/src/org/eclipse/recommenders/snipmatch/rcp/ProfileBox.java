...
/**
 * This is the interface that shows the user's own created snippets, and offers controls to delete or edit them, or to
 * create a new one.
 */
    ...
    public void show() {
        ...
        effectList.addSelectionListener(new SelectionListener() {
            ...
            private void selectEffect() {
                ...
                final int[] selection = effectList.getSelectionIndices();
        ...
        editButton.addSelectionListener(new SelectionListener() {
            ...
            private void editSelected() {
                ...
                final Effect effect = effects.get(effectList.getSelectionIndex());
                shell.close();
                ...
                PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
                    ...
                    public void run() {
                        ...
                        final MessageBox popup = new MessageBox(PlatformUI.getWorkbench().getActiveWorkbenchWindow()
                                .getShell(), SWT.ICON_QUESTION | SWT.YES | SWT.NO | SWT.APPLICATION_MODAL);
                                ...
                                public void deleteEffectSucceeded() {
                                    ...
                                    PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            final MessageBox popup = new MessageBox(PlatformUI.getWorkbench()
            ...
            public void effectLoaded(final Effect effect) {
                ...
                PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (effect.getEnvironmentName().equals(new JavaSnippetMatchEnvironment().getName())) {
