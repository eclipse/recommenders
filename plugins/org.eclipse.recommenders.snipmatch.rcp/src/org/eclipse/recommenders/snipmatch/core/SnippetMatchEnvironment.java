...
public abstract class SnippetMatchEnvironment extends MatchEnvironment {
    ...
    private final HashMap<String, ISnippetNode[]> cachedSnippetNodes;
     ...
     */
    @Override
    protected Object evaluateEffect(final EffectMatchNode effectNode, final Object[] args) {

        final Effect effect = effectNode.getEffect();
        ...
        for (final ISnippetNode snippetNode : snippetNodes) {
     ...
     */
    private String evaluateSnippetNode(final ISnippetNode snippetNode, final HashMap<String, String> variables,
            final EffectMatchNode effectNode) {

        if (snippetNode instanceof FormulaSnippetNode) {

            final FormulaSnippetNode formNode = (FormulaSnippetNode) snippetNode;
            final String value = evaluateFormulaSnippetNode(formNode, variables, effectNode);
