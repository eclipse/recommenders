...
/**
 * This class represents one snippet. A match can contain many snippets in a nested structure. Nesting is no longer used
 * in the current version of SnipMatch. SnipMatch can theoretically support effects that are not snippets. For example,
 * an effect could be a set of instructions to be executed in some program. However, since this library is only being
 * used for the Eclipse plugin, an effect is essentially a snippet.
 */
public class Effect {

    private final ArrayList<String> patterns;
    private final ArrayList<EffectParameter> params;
    private String envName = "";
    /**
     * The major type is used by the server to categorize and nest results. Examples of major types are "expr"
     * (expression) and "stmt" (statement).
     */
    private String majorType = "";
    /**
     * The minor type is used by the client to further check snippet compatibility in nested results. Examples of minor
     * types are "int" and "java.util.ArrayList".
     */
     ...
     */
    public String getPattern(final int index) {
     ...
     *            The search pattern.
     */
    public void setPattern(final int index, final String pattern) {
     ...
     * 
     * @param param
     *            The new search parameter.
     */
    public void addParameter(final EffectParameter param) {
     ...
     */
    public EffectParameter getParameter(final int index) {
     ...
     */
    public EffectParameter getParameter(final String name) {

        for (final EffectParameter param : params) {
     ...
     * 
     * @param name
     *            The name of the search parameter to remove.
     */
