...
public class SendFeedbackThread extends PostThread {
    ...
    public SendFeedbackThread(final MatchClient client, final String query, final MatchNode match,
            final String comment, final int rating, final boolean flag, final boolean isLog, final boolean isStartup,
            final long clientId, final boolean used, final long waitTime, final ISendFeedbackListener listener) {
    ...
    public void run() {
        ...
        final String feedbackString = buildFeedbackString();
    ...
    private String buildFeedbackString() {
        ...
        final Element rootNode = doc.createElement("feedback");
        doc.appendChild(rootNode);

        rootNode.setAttribute("effect", "" + ((EffectMatchNode) match).getEffect().getId());

        final Element queryNode = doc.createElement("query");
        ...
        if (isLog) {
            ...
            final Element commentNode = doc.createElement("comment");
