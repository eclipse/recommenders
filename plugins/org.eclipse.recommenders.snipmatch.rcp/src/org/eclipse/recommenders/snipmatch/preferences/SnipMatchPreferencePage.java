...
/**
 * This class represents a preference page that is used to set up whether to use local search engine or remote search
 * engine .
 * <p>
...
public class SnipMatchPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    /**
     * Creates the local search engine & remote search engine selection checkbox.
     */
    @Override
