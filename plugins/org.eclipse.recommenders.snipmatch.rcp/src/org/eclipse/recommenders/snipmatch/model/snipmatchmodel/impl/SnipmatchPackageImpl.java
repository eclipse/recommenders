...
public class SnipmatchPackageImpl extends EPackageImpl implements SnipmatchPackage {
     ...
     * @generated
     */
    private EClass defaultSnippetRepositoryConfigurationProviderEClass = null;
     ...
     * @generated
     */
    private EClass defaultEclipseGitSnippetRepositoryConfigurationEClass = null;
    ...
    public EClass getDefaultSnippetRepositoryConfigurationProvider() {
        return defaultSnippetRepositoryConfigurationProviderEClass;
    }
    ...
    public EOperation getDefaultSnippetRepositoryConfigurationProvider__GetDefaultConfiguration() {
        return defaultSnippetRepositoryConfigurationProviderEClass.getEOperations().get(0);
    }
    ...
    public EClass getDefaultEclipseGitSnippetRepositoryConfiguration() {
        return defaultEclipseGitSnippetRepositoryConfigurationEClass;
    }
    ...
    public void createPackageContents() {
        ...
        defaultSnippetRepositoryConfigurationProviderEClass = createEClass(DEFAULT_SNIPPET_REPOSITORY_CONFIGURATION_PROVIDER);
        createEOperation(defaultSnippetRepositoryConfigurationProviderEClass,
                DEFAULT_SNIPPET_REPOSITORY_CONFIGURATION_PROVIDER___GET_DEFAULT_CONFIGURATION);

        defaultEclipseGitSnippetRepositoryConfigurationEClass = createEClass(DEFAULT_ECLIPSE_GIT_SNIPPET_REPOSITORY_CONFIGURATION);
    ...
    public void initializePackageContents() {
        ...
        defaultEclipseGitSnippetRepositoryConfigurationEClass.getESuperTypes().add(
                this.getDefaultSnippetRepositoryConfigurationProvider());
        ...
        initEClass(defaultSnippetRepositoryConfigurationProviderEClass,
                DefaultSnippetRepositoryConfigurationProvider.class,
                "DefaultSnippetRepositoryConfigurationProvider", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

        EOperation op = initEOperation(getDefaultSnippetRepositoryConfigurationProvider__GetDefaultConfiguration(),
                null, "getDefaultConfiguration", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
        EGenericType g1 = createEGenericType(ecorePackage.getEEList());
        EGenericType g2 = createEGenericType(this.getSnippetRepositoryConfiguration());
        g1.getETypeArguments().add(g2);
        initEOperation(op, g1);

        initEClass(
                defaultEclipseGitSnippetRepositoryConfigurationEClass,
                DefaultEclipseGitSnippetRepositoryConfiguration.class,
                "DefaultEclipseGitSnippetRepositoryConfiguration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
