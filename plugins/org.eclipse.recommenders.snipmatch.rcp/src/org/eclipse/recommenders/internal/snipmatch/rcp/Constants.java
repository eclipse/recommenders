...
public class Constants {
    ...
    public static final String PREF_DELETED_REPOSITORY_CONFIGURATION_IDS = "org.eclipse.recommenders.snipmatch.rcp.deletedrepositoryconfigurationids"; //$NON-NLS-1$
