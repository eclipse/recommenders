...
public final class Messages extends NLS {
    ...
    public static String WIZARD_GIT_REPOSITORY_ERROR_NO_PROTOCOL_CAN_HANDLE_URI;
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_HOST_URI;
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_PATH_URI;
