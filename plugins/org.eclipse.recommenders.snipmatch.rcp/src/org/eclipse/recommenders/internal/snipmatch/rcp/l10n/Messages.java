...
public final class Messages extends NLS {
    ...
    public static String WIZARD_GIT_REPOSITORY_ERROR_EMPTY_BRANCH_PREFIX_REPOSITORY;
    ...
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_FETCH_URI;
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_PUSH_URI;
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_COMPONENT_HOST;
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_COMPONENT_PASSWORD;
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_COMPONENT_PATH;
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_COMPONENT_PORT;
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_COMPONENT_USER;
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_COMPONENT_HOST;
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_COMPONENT_PASSWORD;
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_COMPONENT_PATH;
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_COMPONENT_PORT;
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_COMPONENT_USER;
    ...
    public static String WIZARD_GIT_REPOSITORY_OPTION_GIT_PUSH_BRANCH_PREFIX;
    public static String WIZARD_GIT_REPOSITORY_OPTION_GERRIT_PUSH_BRANCH_PREFIX;
    public static String WIZARD_GIT_REPOSITORY_OPTION_OTHER_PUSH_BRANCH_PREFIX;
    public static String WIZARD_GIT_REPOSITORY_GIT_PUSH_BRANCH_PREFIX;
    public static String WIZARD_GIT_REPOSITORY_GERRIT_PUSH_BRANCH_PREFIX;
