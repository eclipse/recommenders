...
public final class Messages extends NLS {
    ...
    public static String WIZARD_GIT_REPOSITORY_ERROR_HIERARCHICAL_URL_REQUIRED;
    ...
    public static String WIZARD_GIT_REPOSITORY_ERROR_MISSING_COMPONENT;
    public static String WIZARD_GIT_REPOSITORY_ERROR_INVALID_COMPONENT;
