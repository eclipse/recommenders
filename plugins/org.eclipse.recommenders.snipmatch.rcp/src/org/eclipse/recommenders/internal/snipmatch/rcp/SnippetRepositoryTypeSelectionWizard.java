...
public class SnippetRepositoryTypeSelectionWizard extends SnippetRepositoryWizard {

    private java.util.List<WizardDescriptor> availableWizards;
    private SnippetRepositoryWizard selectedWizard;
    ...
    public void updateSelectedWizard(IWizard wizard) {
        SnippetRepositoryWizard cast = Checks.cast(wizard);
        if (wizard != null) {
