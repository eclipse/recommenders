...
public class SearchRcpContext extends SearchContext {

    private static final Logger LOG = LoggerFactory.getLogger(SearchRcpContext.class);

    public SearchRcpContext(String searchText, JavaContentAssistInvocationContext contentAssistContext) {
