...
public class SnippetMetadataPage extends FormPage {
    ...
    class ProjectCoordinateSelectionDialog extends FilteredItemsSelectionDialog {
        ...
        public ProjectCoordinateSelectionDialog(Shell shell) {
            ...
            dependencyListener = InjectionService.getInstance().requestInstance(IDependencyListener.class);
            ...
            ILabelProvider labelProvider = new LabelProvider() {
                @Override
                public String getText(Object element) {
                    return getStringForElement(element);
                }
        ...
        private String getStringForElement(Object element) {
            ProjectCoordinate pc = cast(element);
        ...
        public String getElementName(Object item) {
            return getStringForElement(item);
        }
