...
public class SnippetMetadataPage extends FormPage {
    ...
    private void initDataBindings() {
        ...
        wpTxtNameText.addChangeListener(changeListener);
        ...
        wpTxtDescriptionText.addChangeListener(changeListener);
        ...
        ppExtraSearchTerms.addListChangeListener(listChangeListener);
        ...
        ppTags.addListChangeListener(listChangeListener);
