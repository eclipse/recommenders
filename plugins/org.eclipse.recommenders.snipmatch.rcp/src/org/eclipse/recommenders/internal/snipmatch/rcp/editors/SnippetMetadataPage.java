    ...
    protected void createFormContent(IManagedForm managedForm) {
        ...
        contentsPart = new AbstractFormPart() {
            ...
            public void initialize(IManagedForm managedForm) {
                ...
                comboContextType = new Combo(managedForm.getForm().getBody(), SWT.DROP_DOWN | SWT.READ_ONLY);
                ...
                final ControlDecoration contextDecoration = new ControlDecoration(comboContextType, SWT.LEFT);
                contextDecoration.setDescriptionText(Messages.ERROR_SNIPPET_CONTEXT_CANNOT_BE_EMPTY);
                contextDecoration.setImage(decorationImage);
                contextDecoration.setMarginWidth(1);

                comboContextType.addModifyListener(new ModifyListener() {

                    @Override
                    public void modifyText(ModifyEvent e) {
                        if (comboContextType.getSelectionIndex() == -1) {
                            contextDecoration.show();
                        } else {
                            contextDecoration.hide();
                        }
                    }
