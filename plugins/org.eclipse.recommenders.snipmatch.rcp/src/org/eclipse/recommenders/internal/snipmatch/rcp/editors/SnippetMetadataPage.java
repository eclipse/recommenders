...
public class SnippetMetadataPage extends FormPage {
    ...
    private DataBindingContext createDataBindingContext() {
        ...
        context.bindValue(targetLocationComboViewer, modelFilenameRestrictionsEnabled, locationEnablementStrategy, null);
        context.bindValue(targetLocationComboViewer, modelAddFilenameRestrictionButtonEnabled, locationEnablementStrategy, null);
        ...
        context.bindValue(targetExtraSearchTermSelected, modelRemoveExtraSearchTermButtonEnabled, objectToBooleanStrategy, null);
