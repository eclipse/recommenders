...
public class SnippetEditor extends FormEditor implements IResourceChangeListener {
    ...
    private SnippetMetadataPage metadataPageEditor;
    ...
    protected void addPages() {
        try {
            metadataPageEditor = new SnippetMetadataPage(this, "meta", "Metadata");
            addPage(metadataPageEditor);
