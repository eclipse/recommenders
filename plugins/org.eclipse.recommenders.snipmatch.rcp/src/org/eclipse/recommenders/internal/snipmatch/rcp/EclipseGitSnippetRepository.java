...
public class EclipseGitSnippetRepository implements ISnippetRepository {
    ...
    public EclipseGitSnippetRepository(String name, File basedir, String remoteUri, String pushUrl,
            String pushBranchPrefix, EventBus bus) {
        this.bus = bus;

        delegate = new GitSnippetRepository(name, new File(basedir, Urls.mangle(remoteUri)), remoteUri, pushUrl,
                pushBranchPrefix);
    ...
    public static ISnippetRepository createRepositoryInstance(EclipseGitSnippetRepositoryConfiguration config) {
        ...
        return new EclipseGitSnippetRepository(config.getName(), basedir, config.getUrl(), config.getPushUrl(),
