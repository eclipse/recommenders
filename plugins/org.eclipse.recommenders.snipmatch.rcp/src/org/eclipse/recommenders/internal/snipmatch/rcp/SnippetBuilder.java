...
public class SnippetBuilder {
    ...
    private ProjectCoordinateProvider pcProvider;

    public SnippetBuilder(CompilationUnit ast, IDocument doc, ITextSelection textSelection) {
        pcProvider = InjectionService.getInstance().requestInstance(ProjectCoordinateProvider.class);
    ...
    private void addImport(ITypeBinding type) {
        ...
        ProjectCoordinate opc = pcProvider.resolve(type).orNull();
        if (opc != null) {
