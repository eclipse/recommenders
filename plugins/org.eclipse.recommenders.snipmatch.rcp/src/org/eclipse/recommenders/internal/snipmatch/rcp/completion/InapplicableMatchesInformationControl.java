...
public class InapplicableMatchesInformationControl extends AbstractInformationControl {
    ...
    protected void createContent(Composite parent) {
        Text txtDescription = new Text(parent, SWT.WRAP);
        Dialog.applyDialogFont(txtDescription);
        txtDescription.setForeground(parent.getForeground());
        txtDescription.setBackground(parent.getBackground());
