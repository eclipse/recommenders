...
public class GitBasedRepositoryConfigurationWizard extends Wizard implements ISnippetRepositoryWizard {
    ...
    @Inject
    public GitBasedRepositoryConfigurationWizard(Repositories repos) {
    ...
    class GitBasedRepositoryConfigurationWizardPage extends WizardPage {
        ...
        private boolean isUriAlreadyAdded(String newText) {
            ...
            for (ISnippetRepository repository : repos.getRepositories()) {
                if (repository instanceof GitSnippetRepository) {
                    String fetchUrl = ((GitSnippetRepository) repository).getRepositoryLocation();
