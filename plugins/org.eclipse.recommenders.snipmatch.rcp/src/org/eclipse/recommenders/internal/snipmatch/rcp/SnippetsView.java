...
public class SnippetsView extends ViewPart implements IRcpService {
    ...
    private boolean selectionContainsDefaultConfigurations() {
        ...
        for (SnippetRepositoryConfiguration config : configs) {
            defaultConfig |= config.isDefaultConfiguration();
        }
    ...
    private void addContextMenu() {
        ...
        menuManager.addMenuListener(new IMenuListener() {
            ...
            public void menuAboutToShow(IMenuManager manager) {
                ...
                addAction("Enable", ELCL_ENABLE_REPOSITORY, manager, enableRepositoryAction);

                addAction("Disable", ELCL_DISABLE_REPOSITORY, manager, disableRepositoryAction);
            }
