...
public class Messages extends NLS {
    ...
    public static String THANKYOUDIALOG_ADD_TO_CC_LIST;
    public static String THANKYOUDIALOG_COMMENT_IF_ERROR;
    public static String THANKYOUDIALOG_COMMENT_ON_REPORT_IF_ERROR;
    public static String THANKYOUDIALOG_INVALID_SERVER_RESPONSE;
    public static String THANKYOUDIALOG_IS_TRACKED_AT;
    ...
    public static String THANKYOUDIALOG_MATCHED_AGAINST_EXISTING_BUG;
    public static String THANKYOUDIALOG_MATCHED_AGAINST_EXISTING_BUG_NEEDS_FURTHER_INFORMATION;
    public static String THANKYOUDIALOG_NOT_ABLE_TO_REPRODUCE;
    public static String THANKYOUDIALOG_NOTE_ADDITIONAL_ACCESS_PERMISSIONS;
    public static String THANKYOUDIALOG_PLEASE_ADD_YOURSELF_TO_CC_LIST;
    public static String THANKYOUDIALOG_PROVIDE_MORE_INFORMATION;
    ...
    public static String THANKYOUDIALOG_UNKNOWN_RESPONSE_RAISE_BUG_AGAINST_ERROR_REPORTER;
    public static String THANKYOUDIALOG_VISIT_BUG_PROVIDE_MORE_DETAILS;
    public static String THANKYOUDIALOG_VISIT_REPORT_FOR_FURTHER_INFORMATION;
    public static String THANKYOUDIALOG_VISIT_REPORT_FURTHER_INFORMATION;
