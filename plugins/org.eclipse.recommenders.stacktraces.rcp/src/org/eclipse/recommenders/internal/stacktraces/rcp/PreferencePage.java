...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        addField(createBooleanFieldEditorAndToolTip(PROP_NEGATE_DEVELOPER_MODE, Messages.FIELD_LABEL_NEGATE_DEVELOPER_MODE,
                Messages.TOOLTIP_NEGATE_DEVELOPER_MODE));
