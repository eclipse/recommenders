...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        addField(createBooleanFieldEditorAndToolTip(PROP_ACTIVATE_DEVELOPER_MODE,
                Messages.FIELD_LABEL_ACTIVATE_DEVELOPER_MODE, Messages.TOOLTIP_ACTIVATE_DEVELOPER_MODE));
