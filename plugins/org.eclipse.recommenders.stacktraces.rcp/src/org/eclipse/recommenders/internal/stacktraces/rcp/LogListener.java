...
public class LogListener implements ILogListener, IStartup {
    ...
    private Cache<String, ErrorReport> cache = CacheBuilder.newBuilder()
            .maximumSize(Configuration.PREVIOUS_ERROR_CACHE_MAXIMUM_SIZE)
            .expireAfterAccess(Configuration.PREVIOUS_ERROR_CACHE_EXPIRE_AFTER_ACCESS_MINUTES, TimeUnit.MINUTES)
            .build();
