...
public class LogListener implements ILogListener, IStartup {
        ...
        Display.getDefault().asyncExec(new Runnable() {
            ...
            public void run() {
                ...
                if (settings.getAction() == SendAction.ASK) {
                    isDialogOpen = true;
                    StacktraceWizard stacktraceWizard = new StacktraceWizard(settings, errorReports);
    ...
    private void sendStatus(final ErrorReport report) {
        ...
        new StacktraceUploadJob(report, settings, URI.create(settings.getServerUrl())).schedule();
    }
