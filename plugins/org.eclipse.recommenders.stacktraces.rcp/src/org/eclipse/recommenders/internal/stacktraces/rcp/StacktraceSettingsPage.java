...
class StacktraceSettingsPage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        setTitle(Messages.SETTINGS_TITEL);
        setDescription(Messages.SETTINGS_DESC);
        ...
        Group personalGroup = new Group(container, SWT.SHADOW_ETCHED_IN | SWT.SHADOW_ETCHED_OUT | SWT.SHADOW_IN
                | SWT.SHADOW_OUT);
        personalGroup.setText(Messages.SETTINGS_GROUP_PERSONAL);
        ...
        {
            new Label(personalGroup, SWT.NONE).setText(Messages.SETTINGS_NAME);
            ...
            dec.setDescriptionText(Messages.SETTINGS_NAME_DESC);
        }
        {
            new Label(personalGroup, SWT.NONE).setText(Messages.SETTINGS_EMAIL);
            ...
            dec.setImage(infoDecoration.getImage());
            dec.setDescriptionText(Messages.SETTINGS_EMAIL_DESC);
        }
        {
            new Label(personalGroup, SWT.NONE).setText(Messages.SETTINGS_ACTION);
        ...
        }
        {
            ...
            anonymizeStacktracesButton.setText(Messages.SETTINGS_ANONYMIZE_STACKTRACES);
            ...
            clearMessagesButton.setText(Messages.SETTINGS_CLEAR_MESSAGES);
        ...
        }
        {
            ...
            dataFactory.grab(true, true).applyTo(feedback);
            {
                ...
                feedbackLink.setText(Messages.SETTINGS_LEARN_MORE);
