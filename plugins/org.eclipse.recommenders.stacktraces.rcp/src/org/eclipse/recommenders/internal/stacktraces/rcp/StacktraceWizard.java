...
public class StacktraceWizard extends Wizard {
    ...
    static class WizardPreferences {
        ...
        public WizardPreferences(StacktracesRcpPreferences stacktracesPreferences) {
            this.name = stacktracesPreferences.name;
            this.email = stacktracesPreferences.email;
            this.mode = stacktracesPreferences.mode;
            this.anonymize = stacktracesPreferences.anonymize();
            this.clearMsg = stacktracesPreferences.clearMsg();
        }
    ...
    public StacktraceWizard(StacktracesRcpPreferences stacktracesPreferences, IObservableList errors) {
        ...
        wizardPreferences = new WizardPreferences(stacktracesPreferences);
    }
    ...
    private void updatePreferences() {
        stacktracesPreferences.setAnonymize(String.valueOf(wizardPreferences.anonymize));
        stacktracesPreferences.setClearMsg(String.valueOf(wizardPreferences.clearMsg));
