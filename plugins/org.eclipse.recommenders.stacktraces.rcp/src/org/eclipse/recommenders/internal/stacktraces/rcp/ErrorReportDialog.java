...
public class ErrorReportDialog extends MessageDialog {
    ...
    private Composite createMessageComposite(Composite parent) {
        ...
        logMessageButton = new Button(container, SWT.CHECK);
        logMessageButton.setText(Messages.FIELD_LABEL_NOT_AN_ERROR);
        logMessageButton.setToolTipText(Messages.TOOLTIP_NOT_AN_ERROR);
