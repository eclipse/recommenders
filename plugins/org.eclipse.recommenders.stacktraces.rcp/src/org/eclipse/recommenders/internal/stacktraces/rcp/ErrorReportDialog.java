...
public class ErrorReportDialog extends MessageDialog {
    ...
    private Button ignoreSimilarInFutureButton;
    ...
    private void updateMessageText() {
        ...
        if (!selection.isEmpty()) {
            ...
            ignoreSimilarInFutureButton.setSelection(activeSelection.isIgnoreSimilarInFuture());
        }
    }
    ...
    private Composite createMessageComposite(Composite parent) {
        ...
        ignoreSimilarInFutureButton = createAndConfigureCheckbox(container,
                Messages.FIELD_LABEL_IGNORE_SIMILAR_ERRORS_IN_FUTURE, Messages.TOOLTIP_IGNORE_SIMILAR_ERRORS_IN_FUTURE);
        ignoreSimilarInFutureButton.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                activeSelection.setIgnoreSimilarInFuture(ignoreSimilarInFutureButton.getSelection());
                updateMessageText();
            }
        });
