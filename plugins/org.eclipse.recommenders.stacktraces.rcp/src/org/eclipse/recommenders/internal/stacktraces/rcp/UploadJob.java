    ...
    private void openPopup(final String message) {
        Display.getDefault().syncExec(new Runnable() {
            ...
            public void run() {
                ...
                Window dialog = new UploadNotificationPopup(shell, message);
                dialog.open();
            }
        });
    }
