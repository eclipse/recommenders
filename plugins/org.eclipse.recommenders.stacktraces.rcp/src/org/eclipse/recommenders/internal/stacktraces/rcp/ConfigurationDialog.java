...
public class ConfigurationDialog extends TitleAreaDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        createActionComposite(personalGroup);
        //
    ...
    private Composite createActionComposite(Composite container) {
        ...
        actionComboViewer = new ComboViewer(container, SWT.READ_ONLY);
        ...
        GridDataFactory.fillDefaults().applyTo(actionComboViewer.getControl());
