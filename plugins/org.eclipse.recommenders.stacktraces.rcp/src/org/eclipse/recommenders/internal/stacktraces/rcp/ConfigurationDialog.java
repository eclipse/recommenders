...
public class ConfigurationDialog extends TitleAreaDialog {
    ...
    public void create() {
        ...
        setMessage("Error Reporting is an automated service to publish logged errors to the Eclipse bugtracker. "
                + "All settings can be changed in the preferences at any time.", IMessageProvider.INFORMATION);
    }
    ...
    private void overrideButtonTexts() {
        ...
        cancel.setText("Don't use error reporting");
