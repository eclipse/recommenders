...
public class ConfigurationDialog extends TitleAreaDialog {
    ...
    private Text createLabelledText(Composite parent, String labelString, String messageString, String tooltipString) {
        ...
        calibrateTooltip(label, tooltipString);
        Text text = new Text(parent, SWT.BORDER);
        text.setMessage(messageString);
        calibrateTooltip(text, tooltipString);
        GridDataFactory.fillDefaults().grab(true, false).applyTo(text);
        return text;
    }

    private void calibrateTooltip(Control control, String toolTipText) {
    ...
    private Group makeAnonymousGroup(Composite container) {
        ...
        calibrateTooltip(anonymizeStacktracesButton, Messages.TOOLTIP_MAKE_STACKTRACE_ANONYMOUS);
        ...
        calibrateTooltip(anonymizeStacktracesButton, Messages.TOOLTIP_MAKE_MESSAGES_ANONYMOUS);
