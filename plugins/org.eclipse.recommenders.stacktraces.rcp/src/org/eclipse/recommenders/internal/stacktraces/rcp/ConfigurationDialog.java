...
public class ConfigurationDialog extends TitleAreaDialog {
    ...
    protected void configureShell(Shell shell) {
        ...
        shell.setText("Do you want to enable Error Reporting?");
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        link.setText(MessageFormat
                .format("Error Reporting is an automated service to analyze logged errors in Eclipse and track them on the Eclipse bugtracker.\n"
                        + "You can help to improve the quality of the Eclipse Platform and installed plugins by reporting errors to the developers.\n"
                        + "All settings can be changed in <a>{0}</a> at any time.", linkToPreferencePage));
    ...
    private Group createPersonalGroup(Composite container, GridLayoutFactory layoutFactory, GridDataFactory dataFactory) {
        ...
        dec.setDescriptionText(Messages.FIELD_MESSAGE_NAME);
        ...
        dec2.setDescriptionText(Messages.FIELD_MESSAGE_EMAIL + Messages.FIELD_DESC_EMAIL);
    ...
    private Group makeAnonymousGroup(Composite container, GridLayoutFactory layoutFactory, GridDataFactory dataFactory) {
        ...
        FieldDecoration infoDecoration = FieldDecorationRegistry.getDefault().getFieldDecoration(DEC_INFORMATION);
        makeAnonymousGroup.setText("Anonymization");
        ...
        ControlDecoration dec = new ControlDecoration(anonymizeStacktracesButton, SWT.TOP | SWT.RIGHT);
        dec.setImage(infoDecoration.getImage());
        dec.setDescriptionText(Messages.TOOLTIP_MAKE_STACKTRACE_ANONYMOUS);
        clearMessagesButton = new Button(makeAnonymousGroup, SWT.CHECK);
        clearMessagesButton.setText(Messages.FIELD_LABEL_MESSAGES);
        ControlDecoration dec2 = new ControlDecoration(clearMessagesButton, SWT.TOP | SWT.RIGHT);
        dec2.setImage(infoDecoration.getImage());
        dec2.setDescriptionText(Messages.TOOLTIP_MAKE_MESSAGES_ANONYMOUS);
