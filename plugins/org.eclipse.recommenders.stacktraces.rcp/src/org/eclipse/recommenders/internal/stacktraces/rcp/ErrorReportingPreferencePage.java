...
public class ErrorReportingPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        addField(new StringFieldEditor(PROP_SERVER, Messages.PREF_SERVER_LABEL, getFieldEditorParent()));
        addField(new StringFieldEditor(PROP_NAME, Messages.SETTINGS_NAME, getFieldEditorParent()));
        addField(new StringFieldEditor(PROP_EMAIL, Messages.SETTINGS_EMAIL, getFieldEditorParent()));
        addField(new ComboFieldEditor(PROP_MODE, Messages.SETTINGS_ACTION, createModeLabelAndValues(),
                getFieldEditorParent()));
        addField(new BooleanFieldEditor(PROP_ANONYMIZE_STACKFRAMES, Messages.SETTINGS_ANONYMIZE_STACKTRACES,
                getFieldEditorParent()));
        addField(new BooleanFieldEditor(PROP_CLEAR_MESSAGES, Messages.SETTINGS_CLEAR_MESSAGES, getFieldEditorParent()));
    ...
    private void addLinks(Composite parent) {
        ...
        learnMoreLink.setText(Messages.SETTINGS_LEARN_MORE);
        ...
        feedbackLink.setText(Messages.SETTINGS_PROVIDE_FEEDBACK);
    ...
    private static String descriptionForMode(Mode mode) {
        switch (mode) {
        case ASK:
            return Messages.SETTINGS_ACTION_REPORT_NOW;
        case IGNORE:
            return Messages.SETTINGS_ACTION_REPORT_NEVER;
        case SILENT:
            return Messages.SETTINGS_ACTION_REPORT_ALWAYS;
        default:
            return mode.name();
        }
    }
