...
public class Settings {
    ...
    public static final String PROP_ANONYMIZE_MESSAGES = "anonymizeMessages";
    public static final String PROP_ANONYMIZE_STACKTRACES = "anonymizeStacktraces";
    ...
    private ImmutableList<String> whitelistedPlugins;

    private ImmutableList<String> whitelistedPackages;
    ...
    public ImmutableList<String> getWhitelistedPlugins() {
        return whitelistedPlugins;
    }

    public ImmutableList<String> getWhitelistedPackages() {
    ...
    private static ImmutableList<String> internal_parseWhitelist(String value) {
