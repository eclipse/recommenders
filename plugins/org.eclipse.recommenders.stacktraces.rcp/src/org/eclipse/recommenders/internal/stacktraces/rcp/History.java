    ...
    private String closeIdentity(ErrorReport report) {
        ...
        report.accept(new VisitorImpl() {
            ...
            public void visit(Status status) {
                ...
                hasher.putString(firstNonNull(status.getPluginId(), ""), UTF_8);
                hasher.putString(firstNonNull(status.getPluginVersion(), ""), UTF_8);
                hasher.putInt(status.getCode());
                hasher.putInt(status.getSeverity());
                super.visit(status);
            }
