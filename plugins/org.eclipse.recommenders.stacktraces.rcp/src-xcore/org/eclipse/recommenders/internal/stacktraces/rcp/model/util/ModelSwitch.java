...
public class ModelSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ModelPackage.ERROR_LOG_EVENT: {
                ErrorLogEvent errorLogEvent = (ErrorLogEvent)theEObject;
                T result = caseErrorLogEvent(errorLogEvent);
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Error Log Event</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Error Log Event</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseErrorLogEvent(ErrorLogEvent object) {
        return null;
    }
