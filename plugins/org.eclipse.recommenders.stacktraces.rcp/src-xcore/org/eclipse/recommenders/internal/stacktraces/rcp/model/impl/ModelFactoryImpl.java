...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case ModelPackage.ERROR_LOG_EVENT: return createErrorLogEvent();
     ...
     * @generated
     */
    public ErrorLogEvent createErrorLogEvent() {
        ErrorLogEventImpl errorLogEvent = new ErrorLogEventImpl();
