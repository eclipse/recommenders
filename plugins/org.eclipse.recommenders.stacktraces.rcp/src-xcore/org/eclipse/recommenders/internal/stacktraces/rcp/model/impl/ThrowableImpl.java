 ...
 * <ul>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ThrowableImpl#getClassname <em>Classname</em>}</li>
...
public class ThrowableImpl extends MinimalEObjectImpl.Container implements org.eclipse.recommenders.internal.stacktraces.rcp.model.Throwable {
    ...
    public void setClassname(String newClassname) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.THROWABLE__CLASSNAME, oldClassname, classname));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.THROWABLE__CLASSNAME:
                return getClassname();
