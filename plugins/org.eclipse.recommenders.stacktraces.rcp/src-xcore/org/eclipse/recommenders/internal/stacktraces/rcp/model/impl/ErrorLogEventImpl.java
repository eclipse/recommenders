...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Error Log Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getAnonymousId <em>Anonymous Id</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getEventId <em>Event Id</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getEclipseBuildId <em>Eclipse Build Id</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getJavaRuntimeVersion <em>Java Runtime Version</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getOsgiWs <em>Osgi Ws</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getOsgiOs <em>Osgi Os</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getOsgiOsVersion <em>Osgi Os Version</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getOsgiArch <em>Osgi Arch</em>}</li>
 *   <li>{@link org.eclipse.recommenders.internal.stacktraces.rcp.model.impl.ErrorLogEventImpl#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ErrorLogEventImpl extends MinimalEObjectImpl.Container implements ErrorLogEvent {
    /**
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.ERROR_LOG_EVENT;
    }
    ...
    public void setAnonymousId(UUID newAnonymousId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__ANONYMOUS_ID, oldAnonymousId, anonymousId));
    }
    ...
    public void setEventId(UUID newEventId) {
        ...
        eventId = newEventId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__EVENT_ID, oldEventId, eventId));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__NAME, oldName, name));
    }
    ...
    public void setEmail(String newEmail) {
        ...
        email = newEmail;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__EMAIL, oldEmail, email));
    }
    ...
    public void setComment(String newComment) {
        ...
        comment = newComment;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__COMMENT, oldComment, comment));
    }
    ...
    public void setEclipseBuildId(String newEclipseBuildId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__ECLIPSE_BUILD_ID, oldEclipseBuildId, eclipseBuildId));
    }
    ...
    public void setJavaRuntimeVersion(String newJavaRuntimeVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__JAVA_RUNTIME_VERSION, oldJavaRuntimeVersion, javaRuntimeVersion));
    }
    ...
    public void setOsgiWs(String newOsgiWs) {
        ...
        osgiWs = newOsgiWs;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__OSGI_WS, oldOsgiWs, osgiWs));
    }
    ...
    public void setOsgiOs(String newOsgiOs) {
        ...
        osgiOs = newOsgiOs;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__OSGI_OS, oldOsgiOs, osgiOs));
    }
    ...
    public void setOsgiOsVersion(String newOsgiOsVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__OSGI_OS_VERSION, oldOsgiOsVersion, osgiOsVersion));
    }
    ...
    public void setOsgiArch(String newOsgiArch) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__OSGI_ARCH, oldOsgiArch, osgiArch));
    }
    ...
    public NotificationChain basicSetStatus(Status newStatus, NotificationChain msgs) {
        ...
        status = newStatus;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__STATUS, oldStatus, newStatus);
    ...
    public void setStatus(Status newStatus) {
        if (newStatus != status) {
            ...
            if (status != null)
                msgs = ((InternalEObject)status).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ERROR_LOG_EVENT__STATUS, null, msgs);
            if (newStatus != null)
                msgs = ((InternalEObject)newStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ERROR_LOG_EVENT__STATUS, null, msgs);
            msgs = basicSetStatus(newStatus, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ERROR_LOG_EVENT__STATUS, newStatus, newStatus));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case ModelPackage.ERROR_LOG_EVENT__STATUS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.ERROR_LOG_EVENT__ANONYMOUS_ID:
                return getAnonymousId();
            case ModelPackage.ERROR_LOG_EVENT__EVENT_ID:
                return getEventId();
            case ModelPackage.ERROR_LOG_EVENT__NAME:
                return getName();
            case ModelPackage.ERROR_LOG_EVENT__EMAIL:
                return getEmail();
            case ModelPackage.ERROR_LOG_EVENT__COMMENT:
                return getComment();
            case ModelPackage.ERROR_LOG_EVENT__ECLIPSE_BUILD_ID:
                return getEclipseBuildId();
            case ModelPackage.ERROR_LOG_EVENT__JAVA_RUNTIME_VERSION:
                return getJavaRuntimeVersion();
            case ModelPackage.ERROR_LOG_EVENT__OSGI_WS:
                return getOsgiWs();
            case ModelPackage.ERROR_LOG_EVENT__OSGI_OS:
                return getOsgiOs();
            case ModelPackage.ERROR_LOG_EVENT__OSGI_OS_VERSION:
                return getOsgiOsVersion();
            case ModelPackage.ERROR_LOG_EVENT__OSGI_ARCH:
                return getOsgiArch();
            case ModelPackage.ERROR_LOG_EVENT__STATUS:
                return getStatus();
        }
