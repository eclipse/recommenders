...
public class Snippet implements ISnippet {
    ...
    private List<String> fileExtensions = Lists.newArrayList();
    ...
    public void setFileExtensions(List<String> fileExtensions) {
        firePropertyChange("fileExtensions", this.fileExtensions, this.fileExtensions = fileExtensions);
    }
    ...
    public void setUuid(UUID uuid) {
        // TODO no property change event necessary?
        this.uuid = uuid;
    }
    ...
    public static Snippet copy(ISnippet snippet) {
        return new Snippet(snippet.getUuid(), snippet.getName(), snippet.getDescription(),
                ...
                snippet.getLocation() != null ? snippet.getLocation() : FILE, snippet.getFileExtensions(),
