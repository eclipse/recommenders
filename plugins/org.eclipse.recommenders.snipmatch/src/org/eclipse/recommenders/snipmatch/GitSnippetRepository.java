...
public class GitSnippetRepository extends FileSnippetRepository {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (!checkoutBranch.equals(FORMAT_VERSION)) {
                    throw new GitBranchException(checkoutBranch, MessageFormat.format(
                            "Could not locate branch \"{0}\", working with branch \"{1}\".", FORMAT_VERSION,
                            checkoutBranch), null);
                }
    ...
    @SuppressWarnings("serial")
    public class GitBranchException extends IOException {
        private final String checkoutVersion;

        public GitBranchException(String checkoutVersion, String message, Throwable cause) {
            super(message, cause);
