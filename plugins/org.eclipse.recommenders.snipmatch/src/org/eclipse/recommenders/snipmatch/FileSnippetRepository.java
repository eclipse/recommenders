...
public class FileSnippetRepository implements ISnippetRepository {
    ...
    private static final String SNIPPETS_FILENAME_FILTER = "^.+\\.json";
    ...
    public void index() throws IOException {
        ...
        try {
            ...
            for (File fSnippet : snippetsdir.listFiles(new ExtensionFileFilter())) {
                try {
    ...
    private final class ExtensionFileFilter implements FileFilter {
        ...
        public boolean accept(File file) {
            return file.getName().matches(SNIPPETS_FILENAME_FILTER);
        }
    }
}
