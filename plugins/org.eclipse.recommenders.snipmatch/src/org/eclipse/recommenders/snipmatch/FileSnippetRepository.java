...
public class FileSnippetRepository implements ISnippetRepository {
    ...
    private Map<File, Float> searchSnippetFiles(String query) {
        ...
        try {
            ...
            return normalizeRelevance(results, maxScore);
    ...
    private Map<File, Float> normalizeRelevance(final Map<File, Float> map, final float maxValue) {
        return Maps.transformValues(map, new Function<Float, Float>() {

            @Override
            public Float apply(Float input) {
                return new Float(input / maxValue);
            }
