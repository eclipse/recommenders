...
import org.eclipse.recommenders.completion.rcp.CompletionContextFunctions.CompletionOnClassContextFunction;
...
public class CompletionRcpModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        functions.addBinding(CCTX_COMPLETION_ON_TYPE).to(CompletionOnClassContextFunction.class);
