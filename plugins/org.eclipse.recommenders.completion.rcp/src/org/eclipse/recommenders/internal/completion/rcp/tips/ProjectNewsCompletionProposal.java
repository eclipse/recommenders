...
public class ProjectNewsCompletionProposal extends AbstractCompletionTipProposal {
    ...
    private static final URI PROJECT_NEWS_URI = Urls.parseURI("http://www.eclipse.org/recommenders/old/project-info/project-page-paragraph.html").get();

    private static final String PREF_PROJECT_NEWS_LAST_CHECKED = "projectNewsLastChecked";
    private static final String PREF_PROJECT_NEWS_LAST_READ = "projectNewsLastRead";
    private static final String PREF_PROJECT_NEWS_LAST_MODIFIED = "projectNewsLastModified";
    ...
    public void apply(ITextViewer viewer, char trigger, int stateMask, int offset) {
        ...
        BrowserUtils.openInDefaultBrowser("http://www.eclipse.org/recommenders");
    }
