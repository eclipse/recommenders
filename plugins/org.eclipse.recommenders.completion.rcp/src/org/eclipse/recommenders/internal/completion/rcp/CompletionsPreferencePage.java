...
public class CompletionsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        addField(new SessionProcessorEditor(PREF_NODE_ID_SESSIONPROCESSORS, "label", getFieldEditorParent()));
    ...
    private final class SessionProcessorEditor extends FieldEditor {
        ...
        private void load(String value) {
            List<SessionProcessorDescriptor> input = SessionProcessorDescriptors.load(value,
        ...
        protected void doStore() {
            ...
            String newValue = SessionProcessorDescriptors.store(descriptors);
