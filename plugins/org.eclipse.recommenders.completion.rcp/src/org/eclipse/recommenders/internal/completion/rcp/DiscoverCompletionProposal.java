...
public class DiscoverCompletionProposal extends AbstractJavaCompletionProposal {
    ...
    public DiscoverCompletionProposal(SharedImages images, int invocationOffset) {
        ...
        StyledString text = new StyledString("Nothing found? Discover new extensions to Code Recommenders",
                DECORATIONS_STYLER);
    ...
    public void apply(ITextViewer viewer, char trigger, int stateMask, int offset) {
        ...
        remoteDiscoveryStrategy.setDirectoryUrl("http://download.eclipse.org/recommenders/discovery/2.0/directory.xml");
    ...
    private final class ConfigureContentAssistInformationControl extends AbstractInformationControl {
        ...
        protected void createContent(Composite parent) {
            ...
            link.setText("There are quite a few extensions available to Code Recommenders. Press return to learn more about Code Recommenders' incubation projects or how to leverage the power of crowd-soucing in your IDE.");
        }
    }
}
