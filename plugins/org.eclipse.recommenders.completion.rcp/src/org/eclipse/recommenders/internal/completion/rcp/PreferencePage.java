...
public class PreferencePage extends org.eclipse.jface.preference.PreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void initDataBindings() {
        ...
        viewer.setLabelProvider(new ObservableMapLabelProvider(elements) {
            @Override
        ...
        IObservableSet processors = set(P_PROCESSORS).observe(prefs);
        viewer.setInput(processors);
        //
        IViewerObservableSet checked = checkedElements(SessionProcessorDescriptor.class).observe(viewer);
        IObservableSet enabled = set(P_ENABLED).observe(prefs);
