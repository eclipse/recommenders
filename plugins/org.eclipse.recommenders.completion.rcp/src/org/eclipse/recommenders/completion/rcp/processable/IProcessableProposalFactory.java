...
public interface IProcessableProposalFactory {
    ...
    // The UIproposals must also be passed so that our new proposals can be made to behave the same way.
    // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=471423
