...
public class ProcessableAnonymousTypeCompletionProposal extends AnonymousTypeCompletionProposal
    ...
    private static Field fSuperType = Reflections.getDeclaredField(AnonymousTypeCompletionProposal.class, "fSuperType")
            .orNull();
    ...
    private static IType findSupertype(AnonymousTypeCompletionProposal uiProposal, CompletionProposal coreProposal,
        ...
        if (fSuperType != null) {
            try {
                IType superType = (IType) fSuperType.get(uiProposal);
                if (superType != null) {
                    return superType;
                }
            } catch (Exception e) {
                Logs.log(LogMessages.LOG_ERROR_EXCEPTION_DURING_CODE_COMPLETION, e);
            }
        }
