...
import org.eclipse.recommenders.internal.rcp.utils.RecommendersUtilsPlugin;
    ...
    public static IJavaCompletionProposal create(CompletionProposal coreProposal, IJavaCompletionProposal uiProposal,
        ...
        try {
            ...
            RecommendersUtilsPlugin.logWarning(
                    "Unknown JDT proposal type '%s' ('%s'). Returning original proposal instead.", c,
                    uiProposal.getDisplayString());
            return uiProposal;
        } catch (final Exception e) {
            RecommendersUtilsPlugin.logWarning(e,
                    "Wrapping JDT proposal '%s' ('%s') failed. Returning original proposal instead.", c,
                    uiProposal.getDisplayString());
            return uiProposal;
        }
    }
