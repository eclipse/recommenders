...
public class ProcessableProposalFactory implements IProcessableProposalFactory {
    ...
    protected <T extends AbstractJavaCompletionProposal & IProcessableProposal> T postConstruct(T res,
            AbstractJavaCompletionProposal uiProposal) {
        res.setProposalProcessorManager(new ProposalProcessorManager(res));
        res.setTriggerCharacters(uiProposal.getTriggerCharacters());
        return res;
    }
