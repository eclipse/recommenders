...
import static org.eclipse.recommenders.completion.rcp.processable.IProcessableProposal.ProposalTag.CONTEXT;
...
public abstract class ProcessableCompletionProposalComputer extends JavaAllCompletionProposalComputer implements
    ...
    public ProcessableCompletionProposalComputer(IProcessableProposalFactory proposalFactory,
        ...
        this(proposalFactory, processors, astProvider, Maps.<CompletionContextKey, ICompletionContextFunction>newHashMap());
    }
