...
public class ProcessableOverrideCompletionProposal
        extends OverrideCompletionProposal implements IProcessableProposal {
    ...
    public static ProcessableOverrideCompletionProposal toProcessableProposal(
            OverrideCompletionProposal proposal, CompletionProposal coreProposal,
        ...
        try {
            ...
            String completionProposal = null;
            ProcessableOverrideCompletionProposal processableProposal = new ProcessableOverrideCompletionProposal(jproject, cu, methodName, paramTypes, start, length, displayName, completionProposal, coreProposal);
    ...
    private ProcessableOverrideCompletionProposal(IJavaProject jproject, ICompilationUnit cu, String methodName, String[] paramTypes, int start, int length, StyledString displayName, String completionProposal, CompletionProposal coreProposal) {
