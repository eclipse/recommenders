...
import static org.eclipse.recommenders.internal.rcp.JavaSelectionUtils.resolveSelectionLocationFromJavaElement;
                                ...
                                try {
                                    if (url.getProtocol().equals("file")) { //$NON-NLS-1$
                                        ...
                                        try {
                                            ...
                                            Activator.logError(e, "Error during javadoc selection %s", url); //$NON-NLS-1$
                                        }
                                    }
                                } catch (final Exception e) {
                                    Activator.logError(e, "Error during javadoc selection %s", url); //$NON-NLS-1$
