...
public final class OverridesProvider extends ApidocProvider {
    ...
    @Inject
    public OverridesProvider(IProjectCoordinateProvider coordsProvider, IOverrideModelProvider modelProvider,
            final JavaElementResolver resolver, EventBus workspaceBus, OverridePatternsModelProvider pStore,
            OverrideDirectivesModelProvider dStore) {
