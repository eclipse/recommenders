...
public class Utilities {
    ...
    public static String getNameOfPreferencePage(String preferencePageID) {
        return getAttributeOfPreferencePage(preferencePageID, "name"); //$NON-NLS-1$
    }

    public static String getCategoryOfPreferencePage(String preferencePageID) {
        return getAttributeOfPreferencePage(preferencePageID, "category"); //$NON-NLS-1$
    }

    public static String getAttributeOfPreferencePage(String preferencePageID, String attribute) {
