...
public class NewNewsItemsNotification extends AbstractUiNotification {
    ...
    @Override
    public void open() {
        ParameterizedCommand command = commandService.createCommand(CommandConstants.ID_READ_NEWS_ITEMS, ImmutableMap.<String, Object>of(
                CommandConstants.PARAMETER_READ_NEWS_ITEMS_NEWS_ITEMS, Collections.singleton(newsItem),
