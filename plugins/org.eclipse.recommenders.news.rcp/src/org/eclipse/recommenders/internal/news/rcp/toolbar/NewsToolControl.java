...
public class NewsToolControl {
    ...
    public NewsToolControl(MToolControl modelElement, NewsRcpPreferences preferences, INewsPollingService newsService,
            IReadItemsStore readItemsStore, ECommandService commandService, EHandlerService handlerService) {
    ...
    /**
     * Causes the singleton {@link BackgroundUpdates} to be instantiated.
     */
    @Inject
    public void initialize(BackgroundUpdates backgroundUpdates) {
        // No op
    }
...
//                        Commands.COMMAND_ID_OPEN_BROWSER,
