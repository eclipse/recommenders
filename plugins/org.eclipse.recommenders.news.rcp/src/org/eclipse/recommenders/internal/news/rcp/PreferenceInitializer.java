...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    private static final long DEFAULT_STARTUP_DELAY = TimeUnit.MINUTES.toMinutes(5);
    ...
    public void initializeDefaultPreferences() {
        ...
        s.putLong(PreferenceConstants.POLLING_DELAY, DEFAULT_STARTUP_DELAY);
        s.put(PreferenceConstants.PREF_FEED_LIST_SORTED, FeedDescriptors.feedsToString(FeedDescriptors.getRegisteredFeeds()));
    }
}
