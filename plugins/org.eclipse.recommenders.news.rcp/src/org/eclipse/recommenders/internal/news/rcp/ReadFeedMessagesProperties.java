...
public class ReadFeedMessagesProperties {
    ...
    public static void writeReadIds(Set<String> readIds) {
        ...
        Set<String> storedIds = getReadIds();
        addAllIds(properties, storedIds);
        addAllIds(properties, readIds);
    ...
    private static void addAllIds(Properties properties, Set<String> ids) {
        for (String id : ids) {
