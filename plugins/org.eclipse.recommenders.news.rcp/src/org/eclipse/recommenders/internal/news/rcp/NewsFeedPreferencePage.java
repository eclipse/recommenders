...
public class NewsFeedPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    private final class FeedEditor extends FieldEditor {
        ...
        protected void removeFeed(FeedDescriptor feed) {
            ...
            MessageDialog confirmDialog = new MessageDialog(NewsFeedPreferencePage.this.getShell(),
                    Messages.CONFIRM_DIALOG_DELETE_FEED_TITLE, null,
                    format(Messages.CONFIRM_DIALOG_DELETE_FEED_MESSAGE, feed.getName()), MessageDialog.QUESTION,
                    new String[] { Messages.CONFIRM_DIALOG_OK, Messages.CONFIRM_DIALOG_CANCEL }, 0);
