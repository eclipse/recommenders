...
public final class Constants {
    ...
    public static final String FEED_NOT_POLLED_YET = "f33d5n07p0113dy37"; //$NON-NLS-1$
    public static final String FEED_NOT_FOUND_AT_URL = "f33dn07f0und47ur1"; //$NON-NLS-1$
