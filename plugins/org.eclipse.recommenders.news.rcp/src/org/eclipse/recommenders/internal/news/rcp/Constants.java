...
public final class Constants {
    ...
    // TODO change below to 30, 1 is for testing purpose
    public static final String DEFAULT_POLLING_INTERVAL = "1"; //$NON-NLS-1$
    public static final int DEFAULT_NOTIFICATION_MESSAGES = 5;
}
