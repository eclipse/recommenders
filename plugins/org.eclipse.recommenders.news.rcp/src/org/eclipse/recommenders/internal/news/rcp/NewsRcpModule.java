...
public class NewsRcpModule extends AbstractModule {
    ...
    @Provides
    @Singleton
    INewsService provideRssService(NewsRcpPreferences preferences, EventBus eventBus,
            NotificationEnvironment environment, JobFacade provider) {
        return new NewsService(preferences, eventBus, environment, provider);
    }
