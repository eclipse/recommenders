...
public class FeedDialog extends TitleAreaDialog {
    ...
    @VisibleForTesting
    protected static String validateFeedDialog(FeedDescriptor currentFeed, String name, String url,
            String pollingInterval, NewsRcpPreferences preferences) {
        ...
        } else if (!isUrlValid(url) || !url.contains(".")) { //$NON-NLS-1$
