 ...
 * evaluation frameworks. The whole framework relies on the usage of {@link IQualifiedName}, i.e. the ability to assign a
 * base {@link ProjectCoordinate} to the Java class container an {@link IName} originates in.
 **/
public interface IModelProvider<K extends IQualifiedName<?>, M> extends Closeable, Openable {
