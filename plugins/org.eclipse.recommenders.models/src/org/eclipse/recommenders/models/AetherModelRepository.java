...
public class AetherModelRepository implements IModelRepository {
    ...
    public void resolve(ModelArchiveCoordinate model) throws Exception {
        ...
        Dependency dependency = new Dependency(new DefaultArtifact(model.getGroupId(), model.getArtifactId(),
                model.getClassifier(), model.getExtension(), model.getVersion()), "model");
