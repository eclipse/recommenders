...
public class ModelIndex implements IModelArchiveCoordinateAdvisor, IModelIndex {
    ...
    public Optional<ModelArchiveCoordinate> suggest(ProjectCoordinate coord, String modelType) {
        ...
        ImmutableSet<ModelArchiveCoordinate> results = suggestCandidates(coord, modelType);
    ...
    public ImmutableSet<ModelArchiveCoordinate> suggestCandidates(ProjectCoordinate coord, String modelType) {
        ...
        Builder<ModelArchiveCoordinate> res = ImmutableSet.builder();
        for (String model : findModelArchiveCoordinatesByTerm(modelType, t1, t2)) {
            Artifact tmp = Artifacts.asArtifact(model);
            res.add(new ModelArchiveCoordinate(tmp.getGroupId(), tmp.getArtifactId(), tmp.getClassifier(), tmp
    ...
    public ImmutableSet<ModelArchiveCoordinate> getKnownModels(String modelType) {
        ...
        Collection<ModelArchiveCoordinate> transform = Collections2.transform(artifacts,
