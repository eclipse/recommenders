...
public class ModelIndex implements IModelArchiveCoordinateAdvisor, IModelIndex {
    ...
    public ImmutableSet<ModelArchiveCoordinate> suggestCandidates(ProjectCoordinate coord, String modelType) {
        ...
        for (String model : queryLuceneIndexForModelCandidates(coord, modelType)) {
            Artifact tmp = Artifacts.asArtifact(model);
            ModelArchiveCoordinate mcoord = new ModelArchiveCoordinate(tmp.getGroupId(), tmp.getArtifactId(),
    ...
    private Set<String> queryLuceneIndexForModelCandidates(ProjectCoordinate coord, String modelClassifier) {
        BooleanQuery query = new BooleanQuery();
        Term coordTerm = new Term(F_COORDINATE, format("%s:%s:*", coord.getGroupId(), coord.getArtifactId()));
