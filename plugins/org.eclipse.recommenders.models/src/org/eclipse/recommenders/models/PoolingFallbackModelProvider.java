 ...
 */
public abstract class PoolingFallbackModelProvider<K extends IUniqueName<?>, M> extends FallbackModelProvider<K, M> {
    ...
    public PoolingFallbackModelProvider(IModelRepository repository, IModelArchiveCoordinateAdvisor index,
    ...
    private final class ModelPoolFactoryMediator extends BaseKeyedPoolableObjectFactory<K, M> {
        ...
        public M makeObject(K key) throws Exception {
            M result = PoolingFallbackModelProvider.super.acquireModel(key).orNull();
            if (result == null) {
        ...
        public void activateObject(K key, M obj) throws Exception {
            PoolingFallbackModelProvider.this.activateModel(obj);
        }

        @Override
        public void passivateObject(K key, M obj) throws Exception {
            PoolingFallbackModelProvider.this.passivateModel(obj);
        }

        @Override
        public void destroyObject(K key, M obj) throws Exception {
            PoolingFallbackModelProvider.this.destroyModel(obj);
        }
    }
