...
import static org.eclipse.recommenders.utils.Versions.canonicalizeOSGIVersion;
...
public class OsgiManifestAdvisor extends AbstractProjectCoordinateAdvisor {
    ...
    private Optional<ProjectCoordinate> extractProjectCoordinateFromManifest(Manifest manifest) {
        ...
        if (version.isPresent()) {
            return ProjectCoordinate.create(groupId, artifactId, canonicalizeOSGIVersion(version.get()));
        }
        return absent();
    }
