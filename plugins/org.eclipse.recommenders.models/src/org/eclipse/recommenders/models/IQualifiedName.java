...
/**
 * An {@link IQualifiedName} is an identifier qualified with a {@link ProjectCoordinate}. The identifier type can be
 ...
 * 
 * @see IModelProvider#acquireModel(IQualifiedName)
 */
public interface IQualifiedName<T> {
     ...
     */
    ProjectCoordinate getQualifier();
