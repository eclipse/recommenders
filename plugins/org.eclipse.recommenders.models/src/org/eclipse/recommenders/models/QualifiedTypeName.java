 ...
 */
public class QualifiedTypeName implements IQualifiedName<ITypeName> {

    private final ITypeName name;
    private final ProjectCoordinate qualifier;

    public QualifiedTypeName(ProjectCoordinate qualifier, ITypeName name) {
        this.name = name;
    ...
    @Override
    public ProjectCoordinate getQualifier() {
        return qualifier;
    }
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("name", getName()).add("qualifier", getQualifier()).toString();
    }
}
