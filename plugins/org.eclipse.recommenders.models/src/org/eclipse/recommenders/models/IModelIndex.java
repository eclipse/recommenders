...
public interface IModelIndex extends IModelArchiveCoordinateAdvisor {
    ...
    ModelArchiveCoordinate INDEX = new ModelArchiveCoordinate("org.eclipse.recommenders", "index", null, "zip", "0.0.0");
    ...
    ImmutableSet<ModelArchiveCoordinate> getKnownModels(String modelType);
