...
public class CallsDemoModelProvider extends PoolingModelProvider<IQualifiedName<ITypeName>, Object> {
    ...
    @Override
    protected Optional<Object> loadModel(ZipFile zip, IQualifiedName<ITypeName> key) throws Exception {
