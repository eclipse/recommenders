...
public interface IModelArchiveCoordinateProvider extends Closeable {
     ...
     * call may lookup the best matches from the {@link ModelRepository}'s model index. If a manual mapping was
    ...
    /**
     * Returns wether the mapping for the given {@link ProjectCoordinate} to a {@link ModelArchiveCoordinate} is
     * overridden.
     */
