...
public class AdvisorsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    private final IProjectCoordinateAdvisorRegistry advisorService;

    @Inject
    public AdvisorsPreferencePage(EventBus bus, IProjectCoordinateAdvisorRegistry advisorService) {
        super(GRID);
        this.bus = bus;
