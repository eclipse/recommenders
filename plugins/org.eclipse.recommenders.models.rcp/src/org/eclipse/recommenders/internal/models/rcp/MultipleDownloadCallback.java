...
final class MultipleDownloadCallback extends DownloadCallback {
    ...
    MultipleDownloadCallback(IProgressMonitor monitor, int totalWorkUnits, int maximumNumberOfDownloads) {
