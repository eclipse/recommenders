...
/*
 * Callback to indicate progress on multiple sequential downloads.
 * The callback works for a given number of downloads and will split the monitored work on each of them.
 * If less downloads are executed than expected, the callback can finish the work to indicate a proper progress.
 * Though it is recommended to call finish after all work is done in any case.
 */
