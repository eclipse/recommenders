...
public class DownloadModelArchiveJob extends Job {
    ...
    protected IStatus run(final IProgressMonitor monitor) {
        try {
            ...
            }).get(); // TODO Since downloading is done by a Job, could we get rid of the whole Executor in
                      // ModelRepository. We just need to make sure that its methods are thread-safe. But that would be
                      // a nice contract to program against.
        } catch (Exception e) {
