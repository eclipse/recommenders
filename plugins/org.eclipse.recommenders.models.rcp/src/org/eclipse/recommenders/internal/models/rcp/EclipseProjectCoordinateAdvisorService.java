...
public class EclipseProjectCoordinateAdvisorService implements IProjectCoordinateAdvisorRegistry,
        IProjectCoordinateAdvisor, IRcpService {

    private final Logger LOG = LoggerFactory.getLogger(getClass());

    private ProjectCoordinateAdvisorService delgate;
    ...
    @Inject
    public EclipseProjectCoordinateAdvisorService(@Named(IDENTIFIED_PROJECT_COORDINATES) File persistenceFile, EventBus bus) {
        bus.register(this);
