    ...
    public void onModelArchiveDownloaded(final ModelArchiveDownloadedEvent e) {
        new UIJob("") {
            ...
            public IStatus runInUIThread(IProgressMonitor monitor) {
                KnownCoordinate element = findCorrespondingElement(e);
                if (element != null) {
            ...
            private KnownCoordinate findCorrespondingElement(final ModelArchiveDownloadedEvent e) {
                KnownCoordinate key = createKey(e.model);
                if (values.contains(key)) {
                    return values.get(values.indexOf(key));
                }
                return null;
            }
