    ...
    public void onModelArchiveDownloaded(final ModelArchiveDownloadedEvent e) {
        new UIJob("") {
            ...
            public IStatus runInUIThread(IProgressMonitor monitor) {
                KnownCoordinate element = findElement(e);
                if (element != null) {
            ...
            private KnownCoordinate findElement(final ModelArchiveDownloadedEvent e) {
                try {
                    KnownCoordinate key = createKey(e.model);
                    return Iterables.find(values, Predicates.equalTo(key));
