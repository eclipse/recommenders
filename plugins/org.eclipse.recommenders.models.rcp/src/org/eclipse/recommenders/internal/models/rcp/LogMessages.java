...
public class LogMessages extends DefaultLogMessage {
    ...
    public static final LogMessages SAVE_PREFERENCES_FAILED = new LogMessages(ERROR, 30,
            Messages.LOG_ERROR_SAVE_PREFERENCES);
    public static final LogMessages ADVISOR_INSTANTIATION_FAILED = new LogMessages(ERROR, 40,
