...
public class ModelsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    private ModelRepositoriesFieldEditor repoEditor;
    ...
    protected void createFieldEditors() {
        repoEditor = new ModelRepositoriesFieldEditor(PREF_REPOSITORY_URL_LIST, Messages.FIELD_LABEL_REPOSITORY_URIS,
    ...
    public class ModelRepositoriesFieldEditor extends FieldEditor {
        ...
        public ModelRepositoriesFieldEditor(String name, String labelText, Composite parent) {
        ...
        private void addNewRepository() {
            RepositoryDetailsDialog newRepositoryDialog = new RepositoryDetailsDialog(getShell(), null,
        ...
        private void editRepository(String selectedRepository) {
            RepositoryDetailsDialog editRepositoryDialog = new RepositoryDetailsDialog(getShell(), selectedRepository,
                    getTableViewerInput(), preferences);
