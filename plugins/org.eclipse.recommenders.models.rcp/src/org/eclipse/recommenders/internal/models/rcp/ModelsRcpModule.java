...
public class ModelsRcpModule extends AbstractModule implements Module {
    ...
    protected void configure() {
        ...
        //
        bind(org.eclipse.recommenders.models.rcp.IProjectCoordinateProvider.class).to(ProjectCoordinateProvider.class)
                .in(SINGLETON);
        ...
        // configure caching
        bind(ManualProjectCoordinateMappings.class).in(SINGLETON);
    ...
    public ProjectCoordinateAdvisorService provideMappingProvider(IModelIndex index,
            ManualProjectCoordinateMappings manualMappingStrategy) {
