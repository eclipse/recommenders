...
public class ModelsRcpModule extends AbstractModule implements Module {
    ...
    public ProjectCoordinateAdvisorService provideMappingProvider(List<IProjectCoordinateAdvisor> availableAdvisors,
        ...
        mappingProvider.setAdvisors(createAdvisorList(availableAdvisors, prefs.advisors));
        return mappingProvider;
    }

    public static List<IProjectCoordinateAdvisor> createAdvisorList(List<IProjectCoordinateAdvisor> availableAdvisors,
            String[] advisors) {
        List<IProjectCoordinateAdvisor> config = Lists.newArrayList();
        for (String name : advisors) {
            if (name.startsWith("!")) {
                continue;
            }
            for (IProjectCoordinateAdvisor advisor : availableAdvisors) {
