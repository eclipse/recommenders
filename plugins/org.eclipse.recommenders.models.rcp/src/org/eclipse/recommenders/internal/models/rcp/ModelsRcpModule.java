...
public class ModelsRcpModule extends AbstractModule implements Module {
    ...
    protected void configure() {
        ...
        bind(IModelArchiveCoordinateResolver.class).to(EclipseModelIndex.class);
        ...
        // configure caching
        bind(ManualMappingStrategy.class).in(SINGLETON);
    ...
    @Singleton
    @Provides
    public IMappingProvider provideMappingProvider(IModelIndex index,
        ...
        mappingProvider.addStrategy(new FingerprintStrategy(index));
