...
public class EclipseModelIndex implements IModelIndex, IRcpService {
    ...
    private Cache<Pair<ProjectCoordinate, String>, Optional<ModelArchiveCoordinate>> cache = CacheBuilder.newBuilder()
    ...
    private final class DownloadModelIndexJob extends DownloadModelArchiveJob {
        ...
        private DownloadModelIndexJob(IModelRepository repository, ModelArchiveCoordinate model, File indexdir) {
