...
import org.eclipse.recommenders.models.rcp.ModelEvents.ModelRepositoryChangedEvent;
...
public class EclipseModelIndex implements IModelIndex, IRcpService {
    ...
    @Inject
    public EclipseModelIndex(EventBus bus) {
        // should we get rid of this by an annotation?
        bus.register(this);
    }

    @Subscribe
    public void onModelRepositoryChanged(ModelRepositoryChangedEvent e) throws IOException {
        close();
        open();
    }
