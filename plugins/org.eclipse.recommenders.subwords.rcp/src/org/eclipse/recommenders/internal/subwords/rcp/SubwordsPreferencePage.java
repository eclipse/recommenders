...
public class SubwordsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        addField(new BooleanFieldEditor(Constants.PREF_COMPLETION_ON_CONSTRUCTORS,
                Messages.FIELD_LABEL_ENABLE_COMPLETION_ON_CONSTRUCTORS, getFieldEditorParent()));
        addField(new BooleanFieldEditor(Constants.PREF_COMPLETION_ON_TYPES,
                Messages.FIELD_LABEL_ENABLE_COMPLETION_ON_TYPES, getFieldEditorParent()));
    }
}
