...
public class Logs {
    ...
    public static interface ILogMessage {
        ...
        /**
         * The logger to use to log this message. This is usually a loger associated with the bundle the log message
         * stems from. But this may, however, be customized and replaced by something else more meaningful.
         */
        ILog log();
    }
    ...
    public static IStatus toStatus(ILogMessage msg, Throwable t, Object... args) {
        String bundleName = msg.log().getBundle().getSymbolicName();
        String message = MessageFormat.format(msg.message(), args);
        return new Status(msg.severity(), bundleName, msg.code(), message, t);
    }
