...
public final class Reflections {
    ...
    public static <T> Optional<Constructor<T>> getConstructor(@Nullable Class<T> declaringClass,
        ...
        try {
            Constructor<T> constructor = declaringClass.getConstructor(parameterTypes);
