...
import org.eclipse.recommenders.internal.news.impl.DownloadService;
import org.eclipse.recommenders.internal.news.impl.FeedItemStore;
...
public class DefaultNewsService implements INewsService {
    ...
    public DefaultNewsService() {
        ...
        this.feedItemStore = new FeedItemStore();
    }
