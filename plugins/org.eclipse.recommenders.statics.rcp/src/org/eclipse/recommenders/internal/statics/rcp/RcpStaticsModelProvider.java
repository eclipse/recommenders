...
public class RcpStaticsModelProvider implements IStaticModelProvider, IRcpService {
    ...
    @Override
    public Optional<IStaticModel> acquireModel(UniqueTypeName key) {
        return delegate.acquireModel(key);
    }

    @Override
    public void releaseModel(IStaticModel value) {
