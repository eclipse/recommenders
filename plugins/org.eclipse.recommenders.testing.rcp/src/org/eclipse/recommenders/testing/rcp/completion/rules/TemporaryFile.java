...
import static org.eclipse.recommenders.testing.rcp.completion.rules.TemporaryProject.*;
...
public class TemporaryFile {
    static final String JAVA_IDENTIFIER_REGEX = "([a-zA-Z_$\\p{Lu}\\p{Ll}]{1}" + "[a-zA-Z_$0-9\\p{Lu}\\p{Ll}\\p{Nl}]*)";
