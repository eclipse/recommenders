...
public class PoolingCallModelProvider extends PoolingModelProvider<QualifiedTypeName, ICallModel> implements
        ICallModelProvider {
    ...
    @Override
    protected Optional<ICallModel> loadModel(ZipFile zip, QualifiedTypeName key) throws Exception {
