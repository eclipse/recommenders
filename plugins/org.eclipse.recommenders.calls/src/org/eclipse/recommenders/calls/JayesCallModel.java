...
public class JayesCallModel implements ICallModel {
    ...
    public static Optional<ICallModel> load(InputStream is, ITypeName type) throws Exception {
        Optional<BayesNet> net = getModel(is, type);
        if (net.isPresent()) {
    ...
    private static Optional<BayesNet> getModel(InputStream is, ITypeName type) throws IOException {
