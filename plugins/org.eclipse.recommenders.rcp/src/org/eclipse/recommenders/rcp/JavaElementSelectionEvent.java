...
public class JavaElementSelectionEvent {
    ...
    public JavaElementSelectionEvent(final IJavaElement element, final JavaSelectionLocation location) {
        this(element, location, null);
    }

    public JavaElementSelectionEvent(final IJavaElement element, final JavaSelectionLocation location, final ASTNode selection) {
