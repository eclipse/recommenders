...
import org.eclipse.recommenders.internal.rcp.links.ContributionExtensionReader;
...
public abstract class AbstractLinkContributionPage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    private final ContributionExtensionReader extensionReader;

    public AbstractLinkContributionPage(String preferencePageId) {
        extensionReader = new ContributionExtensionReader(preferencePageId);
    }
    ...
    public List<ContributionLink> getContributionLinks() {
        return extensionReader.getContributionLinks();
    }
}
