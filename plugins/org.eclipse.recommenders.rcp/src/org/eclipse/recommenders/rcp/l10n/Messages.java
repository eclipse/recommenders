...
public class Messages extends NLS {
    ...
    public static String STATUS_DOWNLOADED;
    public static String STATUS_TRANSFER_FINISHED;
    public static String STATUS_TRANSFER_CORRUPTED;
    public static String STATUS_TRANSFER_FAILED;
