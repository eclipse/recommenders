...
/**
 * Registry for images shared over several Recommenders plugins. It's worth mentioning that this registry supports
 * lazy loading of {@link ImageResource}s, and thus, can be used by other plugins to share their images too.
 * 
