...
public class ModelsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        clearCaches.setText(Messages.PREFPAGE_CLEAR_CACHES);
    ...
    private void createRemoteRepositorySection() {
        ...
        headline.setText(Messages.PREFPAGE_MODEL_REPOSITORY_HEADLINE);
        ...
        description.setText(Messages.PREFPAGE_MODEL_REPOSITORY_INTRO);
        description.setLayoutData(layoutData);

        StringButtonFieldEditor modelRepoFieldEditor = new StringButtonFieldEditor(P_REPOSITORY_URL, Messages.PREFPAGE_URI,
                getFieldEditorParent()) {
            @Override
            protected String changePressed() {
                InputDialog inputDialog = new InputDialog(getShell(), Messages.PREFPAGE_URI_MODEL_REPOSITORY,
                        Messages.PREFPAGE_URI_INSERT, oldValue, new IInputValidator() {
        ...
        addField(new BooleanFieldEditor(P_REPOSITORY_ENABLE_AUTO_DOWNLOAD, Messages.PREFPAGE_ENABLE_AUTO_DOWNLOAD,
                getFieldEditorParent()));
    }
