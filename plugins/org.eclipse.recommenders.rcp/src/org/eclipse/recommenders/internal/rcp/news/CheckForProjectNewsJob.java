...
public class CheckForProjectNewsJob extends Job {
    ...
    public static final String NOTIFY_MESSAGE = "The Code Recommenders project has published a new blog post: {0}. <a href=\"{1}\">Read more...</a>";
    public static final String LOADING_MESSAGE = "Loading Project Newsfeed...";
    ...
    protected String createNotificationLink(List<Pair<String, URL>> entries) {
        ...
        String link = format(NOTIFY_MESSAGE, latest.getFirst(), latest.getSecond());
        return link;
    }
