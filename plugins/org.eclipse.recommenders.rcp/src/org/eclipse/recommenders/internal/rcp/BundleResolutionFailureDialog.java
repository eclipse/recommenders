...
public class BundleResolutionFailureDialog extends MessageDialogWithToggle {
    ...
    public BundleResolutionFailureDialog(Shell parentShell, Collection<Bundle> unresolvedBundles) {
    ...
    protected Control createCustomArea(Composite parent) {
        ...
        addLink(parent, Messages.DIALOG_MESSAGE_BUNDLE_RESOLUTION_FAQ, "http://www.eclipse.org/recommenders/faq/"); //$NON-NLS-1$

        addLink(parent, Messages.DIALOG_MESSAGE_BUNDLE_RESOLUTION_FILE_A_BUG,
                "http://bugs.eclipse.org/bugs/enter_bug.cgi?product=Recommenders"); //$NON-NLS-1$
