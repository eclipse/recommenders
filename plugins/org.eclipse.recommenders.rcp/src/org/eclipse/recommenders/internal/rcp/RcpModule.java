...
import static org.eclipse.recommenders.internal.rcp.Activator.P_REPOSITORY_URL;
...
import org.eclipse.recommenders.utils.rcp.ASTNodeUtils;
import org.eclipse.recommenders.utils.rcp.ASTStringUtils;
import org.eclipse.recommenders.utils.rcp.BindingUtils;
...
public class RcpModule extends AbstractModule implements Module {
    ...
    private ActivePageFinder runUiFinder() {
        ...
        try {
            ...
            Activator.logError(e, "Could not run 'active page finder' that early!"); //$NON-NLS-1$
        }
        return finder;
    }
