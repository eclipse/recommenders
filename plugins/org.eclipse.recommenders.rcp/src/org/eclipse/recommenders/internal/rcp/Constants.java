...
public class Constants {
     ...
     */
    public static final String P_SURVEY_FIRST_ACTIVATION_DATE = "first_activation_date"; //$NON-NLS-1$

    /**
     * Number of plugin activations. Used determine when the survey dialog may be displayed.
     */
    public static final String P_SURVEY_NUMBER_OF_ACTIVATIONS = "activation_count"; //$NON-NLS-1$

    /**
     * Whether the user has elected not to take the survey.
     */
    public static final String P_SURVEY_OPT_OUT = "survey_opt_out"; //$NON-NLS-1$

    /**
     * Whether the survey dialog has already been displayed to the user.
     */
    public static final String P_SURVEY_TAKEN = "survey_already_displayed"; //$NON-NLS-1$
