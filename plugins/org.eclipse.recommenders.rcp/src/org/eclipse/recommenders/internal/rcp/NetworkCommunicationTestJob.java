...
public class NetworkCommunicationTestJob extends Job {
    ...
    private static final String REQUEST_URL = "http://download.codetrails.com/stats/recommenders/network-communication-test/{0}/{1}/{2}/{3}/{4}/"; //$NON-NLS-1$
    ...
    private void doApacheHeadRequest(URI uri, SubMonitor progress) {
        try {
            ...
            HttpHost proxyHost = Proxies.getProxyHost(uri).orNull();
            if (proxyHost != null) {
