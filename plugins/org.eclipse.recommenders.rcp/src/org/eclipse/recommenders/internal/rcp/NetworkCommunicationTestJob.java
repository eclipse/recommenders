...
public class NetworkCommunicationTestJob extends Job {
    ...
    private static final String APACHE_HTTP_REQUEST_URL = "http://download.eclipse.org/recommenders/stats/apache/network-communication-test"; //$NON-NLS-1$
    private static final String P2_HTTP_REQUEST_URL = "http://download.eclipse.org/recommenders/stats/p2/network-communication-test"; //$NON-NLS-1$
    ...
    protected IStatus run(IProgressMonitor monitor) {
        SubMonitor progress = SubMonitor.convert(monitor, Messages.MONITOR_NETWORK_COMMUNICATION_TEST, 2);
    ...
    private void doApacheHeadRequest(URI uri, SubMonitor progress) {
        try {
            ...
            Logs.log(LogMessages.LOG_ERROR_ON_APACHE_HEAD_REQUEST, e, uri);
        }
        progress.done();
    }
    ...
    private void doP2HeadRequest(URI uri, SubMonitor progress) {
        try {
            ...
            Logs.log(LogMessages.LOG_ERROR_ON_P2_HEAD_REQUEST, e, uri);
        }
    }
