...
public final class LogMessages extends DefaultLogMessage {
    ...
    public static final ILogMessage LOG_ERROR_ON_APACHE_HEAD_REQUEST = new LogMessages(ERROR,
            Messages.LOG_ERROR_ON_APACHE_HEAD_REQUEST);
    public static final ILogMessage LOG_ERROR_ON_P2_HEAD_REQUEST = new LogMessages(ERROR,
