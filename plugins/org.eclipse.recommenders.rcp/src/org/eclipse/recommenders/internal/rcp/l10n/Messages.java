...
public final class Messages extends NLS {
    ...
    public static String LOG_ERROR_FAILED_TO_FIND_FIELDS_FOR_TYPE;
    public static String LOG_ERROR_FAILED_TO_FIND_METHODS_FOR_TYPE;
    public static String LOG_ERROR_FAILED_TO_FIND_OVERRIDDEN_METHOD_OF_METHOD;
    public static String LOG_ERROR_FAILED_TO_FIND_SUPERTYPE_NAME_OF_TYPE;
    public static String LOG_ERROR_FAILED_TO_FIND_SUPERTYPE_OF_TYPE;
    public static String LOG_ERROR_FAILED_TO_FIND_TYPE_FROM_SIGNATURE;
    public static String LOG_ERROR_FAILED_TO_FIND_TYPE_HIERARCHY_OF_TYPE;
    public static String LOG_ERROR_FAILED_TO_FIND_TYPE_OF_FIELD;
    ...
    public static String LOG_ERROR_FAILED_TO_RESOLVE_UNQUALIFIED_JDT_TYPE;
    ...
    public static String LOG_WARNING_FAILED_TO_FIND_FIELDS_FOR_TYPE;
    public static String LOG_WARNING_FAILED_TO_FIND_METHODS_FOR_TYPE;
    public static String LOG_WARNING_FAILED_TO_FIND_OVERRIDDEN_METHOD_OF_METHOD;
    public static String LOG_WARNING_FAILED_TO_FIND_SUPERTYPE_NAME_OF_TYPE;
    public static String LOG_WARNING_FAILED_TO_FIND_SUPERTYPE_OF_TYPE;
    public static String LOG_WARNING_FAILED_TO_FIND_TYPE_FROM_SIGNATURE;
    public static String LOG_WARNING_FAILED_TO_FIND_TYPE_HIERARCHY_OF_TYPE;
    public static String LOG_WARNING_FAILED_TO_FIND_TYPE_OF_FIELD;
    public static String LOG_WARNING_FAILED_TO_RESOLVE_TYPE_PARAMETER;
    public static String LOG_WARNING_FAILED_TO_RESOLVE_UNQUALIFIED_JDT_TYPE;
    public static String LOG_WARNING_FAILED_TO_RESOLVE_UNQUALIFIED_TYPE_NAME;
    public static String LOG_WARNING_JAVA_MODEL_EXCEPTION_OCCURRED;
