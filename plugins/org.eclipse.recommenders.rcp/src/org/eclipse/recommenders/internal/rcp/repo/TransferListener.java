...
public class TransferListener extends AbstractTransferListener {
    ...
    public void transferSucceeded(TransferEvent event) {
        ...
        monitor.subTask(String.format(Messages.STATUS_TRANSFER_FINISHED, resource.getResourceName()));
    }
    ...
    public void transferFailed(TransferEvent event) {
        monitor.subTask(String.format(Messages.STATUS_TRANSFER_FAILED, event.getException().getLocalizedMessage()));
    }

    @Override
    public void transferCorrupted(TransferEvent event) {
        monitor.subTask(String.format(Messages.STATUS_TRANSFER_CORRUPTED, event.getException().getLocalizedMessage()));
    }
}
