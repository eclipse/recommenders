...
public class TypesCompletionSessionProcessorTest {
    ...
    public void testSingleTypeRefProposal() throws Exception {
        ...
        verifyWasBoosted(manager, arrayListProcessableProposal);
    }
    ...
    public void testMultipleTypeRefProposals() throws Exception {
        ...
        verifyWasBoosted(arrayListProposalManager, arrayListProcessableProposal);

        sut.process(linkedListProcessableProposal);

        verifyWasBoosted(linkedListProposalManager, linkedListProcessableProposal);
    }

    private void verifyWasBoosted(ProposalProcessorManager arrayListProposalManager,
            IProcessableProposal arrayListProcessableProposal) {
    ...
    public void testMultipleExpectedTypes() throws Exception {
        ...
        verifyWasBoosted(abstractSetProposalManager, abstractSetProcessableProposal);
    }
    ...
    public void testConstructorInvocationProposalWithGenerics() throws Exception {
        ...
        verifyWasBoosted(manager, genericArrayListProcessableProposal);
    }
    ...
    public void testAnonymousClassConstructorInvocationProposal() throws Exception {
        ...
        verifyWasBoosted(manager, abstractSetProcessableProposal);
    }

    @Test
    public void testMethodRefInvocationProposal() throws Exception {
        ...
        ProposalProcessorManager manager = mock(ProposalProcessorManager.class);
        IProcessableProposal arraysAsListProcessableProposal = mockProcessableProposal(manager,
        ...
        verifyWasBoosted(manager, arraysAsListProcessableProposal);
    }
