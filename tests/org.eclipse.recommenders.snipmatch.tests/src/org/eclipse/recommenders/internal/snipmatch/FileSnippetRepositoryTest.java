...
public class FileSnippetRepositoryTest {
    ...
    @Test
    public void testGetFilenameRestrictionsNullFilename() {
        List<String> result = FileSnippetRepository.getFilenameRestrictions(null);

        assertFilenameRestrictions(result);
    }

    @Test
    public void testGetFilenameRestrictionsNoExtension() {
        List<String> result = FileSnippetRepository.getFilenameRestrictions("filename");

        assertFilenameRestrictions(result, "filename");
    }

    @Test
    public void testGetFilenameRestrictionsOneExtension() {
        List<String> result = FileSnippetRepository.getFilenameRestrictions("filename.extension");

        assertFilenameRestrictions(result, "filename.extension", ".extension");
    }

    @Test
    public void testGetFilenameRestrictionsTwoExtensions() {
        List<String> result = FileSnippetRepository.getFilenameRestrictions("filename.first.second");

        assertFilenameRestrictions(result, "filename.first.second", ".first.second", ".second");
    }

    @Test
    public void testGetFilenameRestrictionsExtensionOnly() {
        List<String> result = FileSnippetRepository.getFilenameRestrictions(".gitignore");

        assertFilenameRestrictions(result, ".gitignore");
    }

    @Test
    public void testGetFilenameRestrictionsTwoDots() {
        List<String> result = FileSnippetRepository.getFilenameRestrictions("filename..extension");

        assertFilenameRestrictions(result, "filename..extension", "..extension", ".extension");
    }

    @Test
    public void testGetFilenameRestrictionsStartWithTwoDots() {
        List<String> result = FileSnippetRepository.getFilenameRestrictions("..extension");

        assertFilenameRestrictions(result, "..extension", ".extension");
    }

    private void assertFilenameRestrictions(List<String> actual, String... expected) {
        assertThat(actual, is(equalTo(Arrays.asList(expected))));
