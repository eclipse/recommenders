...
public class FileSnippetRepositoryTest {
    ...
    public void testDeleteSnippetFoundInRepository() throws Exception {
        ISnippet snippet = createSnippet(UUID_A, "name");
        File snippetFile = storeSnippet(snippet);
        sut.open();

        boolean wasDeleted = sut.delete(UUID_A);
    ...
    public void testDeleteSnippetNotFoundInRepository() throws Exception {
        ...
        boolean wasDeleted = sut.delete(UUID_B);
        List<Recommendation<ISnippet>> searchByName = sut.search(new SearchContext("name"));
        List<Recommendation<ISnippet>> blanketSearch = sut.search(new SearchContext(""));
    ...
    public void testDeleteSnippetInRepositoryWithAnotherSnippetToKeep() throws Exception {
        ISnippet snippetToDelete = createSnippet(UUID_A, "name");
        ISnippet snippetToKeep = createSnippet(UUID_B, "name");
    ...
    public void testHasSnippetFoundInRepository() throws Exception {
        ...
        boolean hasSnippet = sut.hasSnippet(UUID_A);
    ...
    public void testHasSnippetNotFoundInRepositoryWithAnotherSnippet() throws Exception {
        ...
        storeSnippet(snippet);
        sut.open();
        boolean hasSnippet = sut.hasSnippet(UUID_B);
    ...
    public void testImportSnippetWhenSnippetWithSameNameAlreadyInRepository() throws Exception {
        ISnippet snippetA = createSnippet(UUID_A, "name");
        storeSnippet(snippetA);

        ISnippet snippetB = createSnippet(UUID_B, "name");
    ...
    public void testImportSnippetWithModifiedMetaData() throws Exception {
        ISnippet originalSnippet = createSnippet(UUID_A, "name");
    ...
    public void testImportSnippetWithModifiedCodeUnderDifferentUuid() throws Exception {
        ...
        Snippet modifiedSnippet = Snippet.copy(originalSnippet);
        modifiedSnippet.setUuid(UUID_B);
    ...
    public void testSearchByDescription() throws Exception {
        Snippet snippet = createSnippet(UUID_A, "name");
    ...
    public void testSearchByLocation() throws Exception {
        ...
        List<Recommendation<ISnippet>> javaTypeMembersSearch = sut.search(new SearchContext("snippet",
                JAVA_TYPE_MEMBERS, EMPTY_CLASSPATH));
    ...
    public void testPreferNameMatchesOverDescription() throws Exception {
        Snippet snippetA = createSnippet(UUID_A, "first");
        storeSnippet(snippetA);
        Snippet snippetB = createSnippet(UUID_B, "second");
        ...
        Recommendation<ISnippet> forFirst = Iterables.tryFind(result, new UuidPredicate(UUID_A)).get();
        Recommendation<ISnippet> forSecond = Iterables.tryFind(result, new UuidPredicate(UUID_B)).get();
    ...
    public void testRelevanceDoesntExceedOne() throws Exception {
        Snippet snippetA = createSnippet(UUID_A, "searchword");
        storeSnippet(snippetA);
        Snippet snippetB = createSnippet(UUID_B, "searchword");
    ...
    public void testEmptyQueryReturnsAllSnippetsOnOneParameterSearch() throws Exception {
        ...
        Optional<Recommendation<ISnippet>> forFirst = Iterables.tryFind(result, new UuidPredicate(UUID_A));
        Optional<Recommendation<ISnippet>> forSecond = Iterables.tryFind(result, new UuidPredicate(UUID_B));
