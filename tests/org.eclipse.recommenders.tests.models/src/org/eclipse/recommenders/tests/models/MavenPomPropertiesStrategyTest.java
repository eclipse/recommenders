...
public class MavenPomPropertiesStrategyTest {
    ...
    private static final String JAR_FILE_NAME_EXAMPLR = "test.jar";
    ...
    public void testValidPomProperties() {
        ...
        IDependencyInfo info = new DependencyInfo(new File(JAR_FILE_NAME_EXAMPLR), DependencyType.JAR);
    ...
    public void testValidPomPropertiesInWrongDirectory() {
        final String propertiesFileName = "invalid/META-INF/maven/org.eclipse.group/org.eclipse.artifact/pom.properties";
    ...
    public void testNotApplicableTyp() {
        ...
        IDependencyInfo info = new DependencyInfo(new File(JAR_FILE_NAME_EXAMPLR), DependencyType.PROJECT);
