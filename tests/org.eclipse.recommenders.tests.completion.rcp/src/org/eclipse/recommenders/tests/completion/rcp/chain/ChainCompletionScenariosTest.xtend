...
class ChainCompletionScenariosTest { 
	...
	def void testCompletionOnMemberCallChainDepth1(){
		val code = CodeBuilder::classbody('''
			...
			File c = $
		''')
		exercise(code, w(newArrayList("b findMethod", "b findMember", "a b findMethod", "a b findMember")));
	}
	...
	def void testCompletionOnMemberCallChainDepth2(){
		...
		''')
		exercise(code, w(newArrayList("b findMethod", "b findMember", "a b findMethod", "a b findMember", "a b findMethod", "a b findMember")));
	}
	...
	def void testCompletionOnSupertypeInMethod(){
		...
		var expected = w(newArrayList(
			...
			"getClass getSuperclass getResourceAsStream",
			"getClass getInterfaces getResourceAsStream",
			"getClass getComponentType getResourceAsStream",
			"getClass getDeclaringClass getResourceAsStream",
			"getClass getEnclosingClass getResourceAsStream",
			"getClass getClasses getResourceAsStream",
			"getClass getDeclaredClasses getResourceAsStream",
			"getClass getResource openStream",
			"getClass asSubclass getResourceAsStream",
	...
	def void testCompletionViaStaticArrayInMethod(){
		...
		''')
		exercise(code, w(newArrayList("useUs findMe", "useUs findMe")));
	}
