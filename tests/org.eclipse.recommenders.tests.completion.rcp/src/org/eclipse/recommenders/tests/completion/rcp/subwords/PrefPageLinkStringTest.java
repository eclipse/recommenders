...
public class PrefPageLinkStringTest {
    ...
    private static final String PREFPAGE_ID_JUNIT = "org.eclipse.jdt.junit.preferences";
    ...
    public void correctLinkStringForPrefPageWithOneTopCategory() {
        assertEquals("Java > JUnit", Utilities.createLinkLabelToPreferencePage(PREFPAGE_ID_JUNIT));
    }
