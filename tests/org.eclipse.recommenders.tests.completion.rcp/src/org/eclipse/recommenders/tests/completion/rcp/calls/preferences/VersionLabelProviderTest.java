...
public class VersionLabelProviderTest {
    ...
    public void test01() {
        ...
        assertSame(VersionLabelProvider.UNKNOWN_DEPENDENCY_DETAILS, sut.getToolTipText(data));
    }
    ...
    public void test03() {
        ...
        assertSame(VersionLabelProvider.KNOWN_DEPENDENCY_DETAILS, sut.getToolTipText(data));
    }
}
