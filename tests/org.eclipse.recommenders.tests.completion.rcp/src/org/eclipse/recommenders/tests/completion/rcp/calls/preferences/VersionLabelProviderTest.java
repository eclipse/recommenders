...
public class VersionLabelProviderTest {
    ...
    public void test01() {
        ...
        assertSame(VersionLabelProvider.UNKNOWN_DETAILS_DEPENDENCY, sut.getToolTipText(data));
    }
    ...
    public void test03() {
        ...
        assertSame(VersionLabelProvider.KNOWN_DETAILS_DEPENDENCY, sut.getToolTipText(data));
    }
}
