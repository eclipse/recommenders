...
import static org.eclipse.recommenders.rcp.JavaSelectionEvent.JavaSelectionLocation.*;
...
import org.eclipse.recommenders.rcp.JavaSelectionEvent.JavaSelectionLocation;
...
public class JavaSelectionTestUtils {
    ...
    public static JavaSelectionEvent mockJavaSelection(Class<? extends IJavaElement> clazz,
            JavaSelectionLocation location) {
        IJavaElement element = mock(clazz);
        JavaSelectionEvent selection = mock(JavaSelectionEvent.class);
