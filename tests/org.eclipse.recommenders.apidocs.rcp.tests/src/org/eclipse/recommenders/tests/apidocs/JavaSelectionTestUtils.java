...
import static org.eclipse.recommenders.rcp.JavaElementSelectionEvent.JavaSelectionLocation.*;
...
import org.eclipse.recommenders.rcp.JavaElementSelectionEvent.JavaSelectionLocation;

public class JavaSelectionTestUtils {

    public static final JavaElementSelectionEvent TYPE_IN_TYPE_DECLARATION = mockJavaSelection(IType.class, TYPE_DECLARATION);
    ...
    public static final JavaElementSelectionEvent ANNOTATION_IN_METHOD_DECLARATION = mockJavaSelection(IAnnotation.class,
            METHOD_DECLARATION);
    ...
    public static JavaElementSelectionEvent mockJavaSelection(Class<? extends IJavaElement> clazz,
            JavaSelectionLocation location) {
        IJavaElement element = mock(clazz);
        JavaElementSelectionEvent selection = mock(JavaElementSelectionEvent.class);
