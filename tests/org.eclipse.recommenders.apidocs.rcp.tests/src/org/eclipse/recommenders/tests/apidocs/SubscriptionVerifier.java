...
public class SubscriptionVerifier {
    ...
    private Map<JavaSelectionEvent, Map<ApidocProvider, String>> subscriptions = Maps.newHashMap();

    public void addResult(JavaSelectionEvent selection, ApidocProvider provider, String actualMethodName) {
    ...
    private Map<ApidocProvider, String> get(JavaSelectionEvent selection) {
    ...
    public void assertSubscription(JavaSelectionEvent selection, ApidocProvider provider, String expectedMethodName) {
        Map<ApidocProvider, String> methodsByProvider = get(selection);
