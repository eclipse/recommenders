...
import org.eclipse.recommenders.internal.stacktraces.rcp.notifications.MoreInformationNotification;
...
public class NotificationsAction implements IWorkbenchWindowActionDelegate {
    ...
    public void init(IWorkbenchWindow window) {
        notifications.put("configuration", new ConfigurationNotification(PreferenceInitializer.getDefault(), PlatformUI
                .getWorkbench().getActiveWorkbenchWindow().getShell()));
        notifications.put("report", new ReportErrorNotification());
