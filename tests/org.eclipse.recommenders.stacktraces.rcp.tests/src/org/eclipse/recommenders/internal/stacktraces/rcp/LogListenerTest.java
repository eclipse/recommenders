...
public class LogListenerTest {
    ...
    public void init() {
        ...
        Mockito.when(sut.readSettings()).thenAnswer(new Answer<Settings>() {
            ...
            public Settings answer(InvocationOnMock invocation) throws Throwable {
                 ...
                 */
                settings.getWhitelistedPackages().add("org.junit");
                settings.getWhitelistedPackages().add("org.mockito");
                return settings;
            }
        });
    }
    ...
    @Test
    public void testNoReportIfStacktraceContainsNoWhitelistedClasses() {
        settingsOverrider = new SendActionSettingsOverrider(SILENT);
        Exception exception = new Exception();
        exception.setStackTrace(new StackTraceElement[] {
                new StackTraceElement(TEST_PLUGIN_ID + ".AnyClass", "anyMethod", "AnyClass.java", -1),
                new StackTraceElement("definitly.not.whitelisted.package" + ".AnyOtherClass", "anyOtherMethod",
                        "AnyOtherClass.java", -1) });
        Status status = new Status(IStatus.ERROR, TEST_PLUGIN_ID, "test message", exception);
