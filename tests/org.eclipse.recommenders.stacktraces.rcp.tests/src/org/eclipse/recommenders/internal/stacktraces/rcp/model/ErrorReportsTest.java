...
public class ErrorReportsTest {
    ...
    public void testMultistatusChildFiltering() {
        ...
        IStatus s1 = new Status(IStatus.ERROR, "org.eclipse.ui.monitoring_1.0.0.v20141021-2031",
        ...
        IStatus s2 = new Status(
                IStatus.ERROR,
                "org.eclipse.ui.monitoring_1.0.0.v20141021-2031",
        ...
        IStatus s4 = new Status(IStatus.ERROR, "org.eclipse.ui.monitoring_1.0.0.v20141021-2031",
                "Thread 'Worker-10' tid=42 (RUNNABLE)", e4);
        ...
        IStatus multi = new MultiStatus("org.eclipse.ui.monitoring_1.0.0.v20141021-2031", 0, new IStatus[] { s1, s2,
                s3, s4, s5 }, "UI freeze of 10s at 08:09:02.936", newRuntimeException("stand-in-stacktrace"));
        // 2, 3 and 5 should be filtered, 1 and 4 remain
        org.eclipse.recommenders.internal.stacktraces.rcp.model.Status newStatus = ErrorReports.newStatus(multi,
                settings);
        assertThat(newStatus.getChildren().size(), is(2));
