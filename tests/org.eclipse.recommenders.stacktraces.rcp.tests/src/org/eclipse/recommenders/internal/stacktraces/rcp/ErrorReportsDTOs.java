...
public class ErrorReportsDTOs {
    ...
    public static StackTraceElement createStackTraceElementDTO(String className, String methodName) {
    ...
    public static Status createStatusDTO(int severity, String pluginId, String message) {
        return createStatusDTO(severity, pluginId, message, null);
    }

    public static Status createStatusDTO(int severity, String pluginId, String message, java.lang.Throwable exception) {
    ...
    public static Throwable createThrowableDTO(String className) {
