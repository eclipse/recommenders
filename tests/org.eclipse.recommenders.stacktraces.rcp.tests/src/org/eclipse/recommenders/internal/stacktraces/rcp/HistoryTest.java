...
public class HistoryTest {
    ...
    public void testRememberSameStacktrace() {
        ...
        Status status = ErrorReportsDTOs.createStatusDTO(IStatus.ERROR, "plugin.id", "a message", throwable);
        ...
        Status status2 = ErrorReportsDTOs.createStatusDTO(IStatus.ERROR, "plugin.id", "a message", throwable2);
    ...
    public void testDifferentPlugin() {
        ...
        Throwable throwable = new Throwable();
        throwable.setStackTrace(createStacktraceForClasses("any.Class1", "any.Class2"));
        Status status = ErrorReportsDTOs.createStatusDTO(IStatus.ERROR, "plugin.id.1", "a message", throwable);
        report.setStatus(status);
        sut.remember(report);
        ...
        Throwable throwable2 = new Throwable();
        throwable2.setStackTrace(createStacktraceForClasses("any.Class1", "any.Class2"));
        Status status2 = ErrorReportsDTOs.createStatusDTO(IStatus.ERROR, "plugin.id.2", "a message", throwable2);
        report2.setStatus(status2);
