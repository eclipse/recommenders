...
public class UrlsTest {
    ...
    private static final String HTTP_ABSOLUTE_URI = "http://download.eclipse.org/recommenders";
    private static final String HTTPS_ABSOLUTE_URI = "http://download.eclipse.org/recommenders";
