...
public class UrlsTest {
    ...
    private static final String ESCAPED_HTTP_ABSOLUTE_URI = "http___download_eclipse_org_123_recommenders_models_2_0_v201210_1212_data_key_value_fragid1";
    private static final String HTTP_ABSOLUTE_URI = "http://download.eclipse.org:123/recommenders/models/2.0/v201210_1212/data?key=value#fragid1";
    private static final String HTTP_ABSOLUTE_URI_WITH_USERNAME = "http://user@download.eclipse.org:123/recommenders/models/2.0/v201210_1212/data?key=value#fragid1";
    private static final String HTTP_ABSOLUTE_URI_WITH_USERNAME_AND_PASSWORD = "http://user:password@download.eclipse.org:123/recommenders/models/2.0/v201210_1212/data?key=value#fragid1";
