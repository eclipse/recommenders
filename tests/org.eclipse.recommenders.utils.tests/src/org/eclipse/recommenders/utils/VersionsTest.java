...
public class VersionsTest {
    ...
    public void testNothingIsAddedIfItIsNotNecessary() {
        assertEquals("2.3.0", Versions.canonicalizeVersion("2.3.0"));
    }

    @Test
    public void testMicroVersionIsAddedCorrect() {
        assertEquals("2.3.0", Versions.canonicalizeVersion("2.3"));
    }

    @Test
    public void testAddMinorAndMicroVersionCorrect() {
        assertEquals("2.0.0", Versions.canonicalizeVersion("2"));
    }

    @Test
    public void testMavenCoordinateIsCanonicalizeCorrect() {
        assertEquals("2.3.0", Versions.canonicalizeVersion("2.3-SNAPSHOT"));
    }

    @Test
    public void testOsgiCoordinateIsCanonicalizeCorrect() {
        assertEquals("2.3.0", Versions.canonicalizeVersion("2.3.Beta"));
    }

    @Test
    public void testVerionWithoutPreAndSuffixAreCanonicalizedCorrect() {
        assertEquals("1.0.2", Versions.canonicalizeVersion("1.0.2"));
    }

    @Test
    public void testReturnInputIfCanonicalizationFailed() {
        assertEquals("Beta", Versions.canonicalizeVersion("Beta"));
    }
}
