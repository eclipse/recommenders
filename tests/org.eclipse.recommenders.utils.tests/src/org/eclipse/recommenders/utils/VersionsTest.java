...
public class VersionsTest {
    ...
    public void testNothingIsAddedIfItIsNotNecessary() {
        assertEquals("2.3.0", Versions.addMissingVersionPartsIfNecessary("2.3.0"));
    }

    @Test
    public void testMicroVersionIsAddedCorrect() {
        assertEquals("2.3.0", Versions.addMissingVersionPartsIfNecessary("2.3"));
    }

    @Test
    public void testAddMicroVersionFailed() {
        assertNotEquals("2.3.0", Versions.addMissingVersionPartsIfNecessary("2.3-SNAPSHOT"));
    }

    @Test
    public void testAddMinorAndMicroVersionCorrect() {
        assertEquals("2.0.0", Versions.addMissingVersionPartsIfNecessary("2"));
    }
