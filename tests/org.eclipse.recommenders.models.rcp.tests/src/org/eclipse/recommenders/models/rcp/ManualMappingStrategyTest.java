...
import org.eclipse.recommenders.internal.models.rcp.ManualProjectCoordinateMappings;
...
public class ManualMappingStrategyTest {
    ...
    public void returnAbsentWhenNoMappingExist() throws IOException {
        ManualProjectCoordinateMappings sut = new ManualProjectCoordinateMappings(persistenceFile);
    ...
    public void storageOfManualMappingsWorksCorrect() throws IOException {
        ...
        sut = new ManualProjectCoordinateMappings(persistenceFile);
        sut.open();
