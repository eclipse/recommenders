...
import static org.eclipse.recommenders.internal.rcp.JavaSelectionUtils.*
...
class JavaSelectionLocationTest {
    ...
    def private exerciseAndVerify(CharSequence code,
        List<JavaSelectionLocation> expected) {
