...
public class RssReaderTest {
    ...
    public void testNullString() {
        List<Pair<String, URL>> entries = RssReader.getEntries(null, new Date());
        assertThat(entries.isEmpty(), is(true));
    }

    @Test
    public void testEmptyString() {
        List<Pair<String, URL>> entries = RssReader.getEntries("", new Date());
        assertThat(entries.isEmpty(), is(true));
    }
    ...
    public void testNullDate() throws Exception {
        ...
        List<Pair<String, URL>> entries = RssReader.getEntries(xml.build(), null);
        assertThat(entries.isEmpty(), is(true));
    }

    @Test
    public void testIllegalXml() {
        List<Pair<String, URL>> entries = RssReader.getEntries("<rss><item></rss>", new Date());
        assertThat(entries.isEmpty(), is(true));
    }
    ...
    public void testSingleEntry() throws Exception {
        ...
        XmlBuilder xml = new XmlBuilder();
        xml.addEntry(publishDate, TITLE_1, URL_1);

        List<Pair<String, URL>> entries = RssReader.getEntries(xml.build(), lastCheckedDate);
    ...
    public void testTwoEntries() throws Exception {
        ...
        xml.addEntry(publishDate2, TITLE_2, URL_2);
    ...
    public void testTwoEntriesOneIllegal() throws Exception {
        ...
        XmlBuilder xml = new XmlBuilder();
        xml.addEntry(publishDate1, TITLE_1, URL_1);
        xml.addEntry(publishDate2, TITLE_2, "foo::bar");
    ...
    private class XmlBuilder {
        ...
        public XmlBuilder addEntry(Date date, String title, String url) {
            sb.append("<item>");
