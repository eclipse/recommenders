...
public class DefaultFeedItemStoreTest {
    ...
    private static final FeedItem FIRST_ITEM = new FeedItem("Item 1", new Date(0L),
            URI.create("http://www.example.org/items/1"), null);
    private static final FeedItem SECOND_ITEM = new FeedItem("Item 2", new Date(1000L),
    ...
    public void testUpdateWithAddedItems() throws Exception {
        ...
        List<FeedItem> newItems = sut.udpate(FEED_URI, asInputStream(FIRST_ITEM, SECOND_ITEM), null);
    ...
    public void testUpdateWithRemovedItems() throws Exception {
        ...
        List<FeedItem> newItems = sut.udpate(FEED_URI, asInputStream(SECOND_ITEM), null);
    ...
    public void testGetFeedItemsWithoutUpdate() {
        ...
        List<FeedItem> items = sut.getFeedItems(FEED_URI);
    ...
    private static InputStream asInputStream(FeedItem... items) {
