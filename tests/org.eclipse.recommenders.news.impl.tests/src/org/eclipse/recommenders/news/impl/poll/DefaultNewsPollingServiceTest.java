...
import static org.eclipse.recommenders.news.api.poll.PollingPolicy.every;
import static org.eclipse.recommenders.news.api.poll.PollingResult.Status.NOT_DOWNLOADED;
...
public class DefaultNewsPollingServiceTest {
    ...
    @Test
    public void testPollMissingFeedNeverPolledBefore() throws Exception {
        ...
        PollingRequest request = new PollingRequest(FEED_URI, every(1, HOURS));
        ...
        verifyZeroInteractions(feedItemStore);
    }
}
