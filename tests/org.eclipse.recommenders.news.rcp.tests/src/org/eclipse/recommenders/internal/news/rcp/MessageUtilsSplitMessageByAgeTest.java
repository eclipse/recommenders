...
public class MessageUtilsSplitMessageByAgeTest {
    ...
    private static final Date MONDAY_2016_01_04 = getDate(2016, Calendar.JANUARY, 4);
    private static final Date WEDNESDAY_2015_12_23 = getDate(2015, Calendar.DECEMBER, 23);
    private static final Date FRIDAY_2015_11_20 = getDate(2015, Calendar.NOVEMBER, 20);
    ...
    public static Collection<Object[]> scenarios() {
        ...
        // Bug 485115
        // scenarios.add(new Object[] { on(MONDAY_2016_01_04),
        // messagesFrom(WEDNESDAY_2015_12_23), expectedGroupings(today(), yesterday(), thisWeek(), lastWeek(),
        // thisMonth(), lastMonth(WEDNESDAY_2015_12_23), thisYear(), older(WEDNESDAY_2015_12_23)),
        // Locale.US });

        // Bug 485115 fixed
        scenarios.add(new Object[] { on(MONDAY_2016_01_04), messagesFrom(WEDNESDAY_2015_12_23, FRIDAY_2015_11_20),
                expectedGroupings(today(), yesterday(), thisWeek(), lastWeek(), thisMonth(),
                        lastMonth(WEDNESDAY_2015_12_23), thisYear(), older(FRIDAY_2015_11_20)),
                Locale.US });
