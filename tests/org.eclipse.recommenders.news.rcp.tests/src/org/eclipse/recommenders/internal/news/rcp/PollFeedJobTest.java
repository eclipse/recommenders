...
public class PollFeedJobTest {
    ...
    public void testFeedsWithSameIdBelongsTo() throws MalformedURLException {
        PollFeedJob firstJob = new PollFeedJob(FIRST_ELEMENT);
        PollFeedJob secondJob = new PollFeedJob(FIRST_ELEMENT);
    ...
    public void testFeedsWithDifferentIdDoesntBelongsTo() {
        PollFeedJob firstJob = new PollFeedJob(FIRST_ELEMENT);
        PollFeedJob secondJob = new PollFeedJob(SECOND_ELEMENT);
