...
public class MessageUtilsValidateFeedDialogTest {
    ...
    private static final String INVALID_FEED_URL = "http://eclipse";
    ...
    public MessageUtilsValidateFeedDialogTest(FeedDescriptor feed, String name, String url, String pollingInterval,
    ...
    public static Collection<Object[]> scenarios() {
        ...
        scenarios.add(new Object[] { null, VALID_FEED_NAME, VALID_FEED_URL, VALID_FEED_POLLING_INTERVAL, null });
        scenarios.add(new Object[] { TestUtils.enabled(VALID_FEED_ID), VALID_FEED_NAME, VALID_FEED_URL,
                VALID_FEED_POLLING_INTERVAL, null });
    ...
    public void testValidateFeedDialog() {
        ...
        assertThat(MessageUtils.validateFeedDialog(feed, name, url, pollingInterval, preferences),
