...
import org.eclipse.recommenders.internal.jayes.io.util.JBIFConstants;
...
public class JayesBifTest {
    ...
    public void testReadDefaultNode() throws IOException {
        ...
        // header
        buffer.putInt(JBIFConstants.MAGIC_NUMBER);
        buffer.putInt(JBIFConstants.FORMAT_VERSION);
        // network
