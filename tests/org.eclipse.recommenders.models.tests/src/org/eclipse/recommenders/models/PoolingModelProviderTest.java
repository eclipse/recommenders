...
public class PoolingModelProviderTest {
    ...
    QualifiedTypeName someName = new QualifiedTypeName(ProjectCoordinate.UNKNOWN, OBJECT);
    ...
    PoolingModelProvider<QualifiedTypeName, String> sut = create();
    ...
    private PoolingModelProvider<QualifiedTypeName, String> create() {
    ...
    private final class PoolingModelProviderStub extends PoolingModelProvider<QualifiedTypeName, String> {
        ...
        @Override
        protected Optional<String> loadModel(ZipFile zip, QualifiedTypeName key) throws Exception {
