...
public class OsgiManifestStrategyTest {
    ...
    @Test
    public void extractProjectCoordinateWithOnePartBundleNameCorrect() {
    ...
    @Test
    public void extractProjectCoordinateWithTwoPartBundleNameCorrect() {
        DependencyInfo info = new DependencyInfo(jarFileExample, DependencyType.JAR);
    ...
    @Test
    public void extractProjectCoordinateWithThreePartBundleNameCorrect() {
        DependencyInfo info = new DependencyInfo(jarFileExample, DependencyType.JAR);
    ...
    @Test
    public void extractProjectCoordinateWithFourPartBundleNameCorrect() {
        DependencyInfo info = new DependencyInfo(jarFileExample, DependencyType.JAR);
