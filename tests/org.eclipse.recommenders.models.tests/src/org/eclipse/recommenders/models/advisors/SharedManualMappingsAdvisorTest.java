...
public class SharedManualMappingsAdvisorTest {
    ...
    public void testEmptyMappingsFile() throws IOException {
        ...
        Optional<ProjectCoordinate> suggestion = sut
                .doSuggest(jarDependency("/home/user/workspace/project/lib/example.jar"));
    ...
    public void testMultiEntryMappingsFile() throws IOException {
        ...
        Optional<ProjectCoordinate> suggestion = sut
                .doSuggest(jarDependency("/home/user/workspace/project/lib/second.jar"));
    ...
    private DependencyInfo jarDependency(String path) {
        return new DependencyInfo(new File(path), JAR);
    }
}
