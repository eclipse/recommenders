...
public class ConstructorCompletionSessionProcessorTest {
    ...
    public void testUnsupportedCompletionLocation() {
        ...
        setUpModelRepository(new UniqueTypeName(JRE_1_6_0, OBJECT), objectType,
    ...
    public void testNoModelFound() {
        ...
        setUpModelRepository(new UniqueTypeName(JRE_1_6_0, OBJECT), objectType, NO_MODEL);
    ...
    public void testNoRecommendations() {
        ...
        setUpModelRepository(new UniqueTypeName(JRE_1_6_0, OBJECT), objectType, model);
    ...
    private void setUpModelRepository(UniqueTypeName uniqueTypeName, @Nullable IType expectedType,
