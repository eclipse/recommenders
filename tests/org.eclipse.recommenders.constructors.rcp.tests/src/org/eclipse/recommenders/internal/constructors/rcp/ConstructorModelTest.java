...
public class ConstructorModelTest {
    ...
    private final static IMethodName OBJECT_HASHCODE = VmMethodName.get("Ljava/lang/Object.hashCode()I");
    private final static IMethodName OBJECT_TO_STRING = VmMethodName
