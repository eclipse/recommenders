...
public class NewsPreferencePageUITest {
    ...
    public void tearDown() {
        // Close feed dialog or preference page
        bot.button("Cancel").click();

        if (bot.activeShell().getText().equals("Preferences")) {
            // The first 'Cancel' click may have closed the feed dialog or the preference page.
            // Only click again if the preference page is still open.
            bot.button("Cancel").click();
        }
    }
