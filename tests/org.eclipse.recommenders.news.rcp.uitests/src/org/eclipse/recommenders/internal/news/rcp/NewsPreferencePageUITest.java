...
public class NewsPreferencePageUITest {
    ...
    // below two tests are ignored, because they're version dependent - they depends on PreferencePage category, it
    // might change. Secondly, they fail on Hudson CI without any reason.
    @Ignore
    @Test
