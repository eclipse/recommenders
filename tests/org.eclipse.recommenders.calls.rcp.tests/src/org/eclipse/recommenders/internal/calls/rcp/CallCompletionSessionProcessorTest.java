...
public class CallCompletionSessionProcessorTest {
    ...
    public void testCompletionOnObjectWithoutRecommendations() {
        IType objectType = mock(IType.class);

        setUp(CompletionOnMessageSend.class, new UniqueTypeName(JRE_1_6_0, OBJECT), objectType, NO_OBSERVATIONS, "",
                NO_RECOMMENDATIONS);
    ...
    public void testCompletionOnObjectWithObservedMethods() {
        ...
        setUp(CompletionOnMessageSend.class, new UniqueTypeName(JRE_1_6_0, OBJECT), objectType,
    ...
    @Test
    public void testContextGetCompletionNodeIsNull() {
        IType objectType = mock(IType.class);
        setUp(null, new UniqueTypeName(JRE_1_6_0, OBJECT), objectType, NO_OBSERVATIONS, null,
                ImmutableList.of(newRecommendation(OBJECT_HASH_CODE, 0.5)));
    ...
    @Test
    public void testContextGetCompletionNodeIsNullNeedsBetterName() {
        IType objectType = mock(IType.class);
        setUp(CompletionOnJavadocMessageSend.class, new UniqueTypeName(JRE_1_6_0, OBJECT), objectType, NO_OBSERVATIONS,
                null, ImmutableList.of(newRecommendation(OBJECT_HASH_CODE, 0.5)));
    ...
    public void testCannotObtainUniqueNameForReceiverType() {
        ...
        setUp(CompletionOnMessageSend.class, null, objectType, ImmutableList.of(OBJECT_HASH_CODE), "",
                ImmutableList.of(newRecommendation(OBJECT_EQUALS, 0.5)));
    ...
    public void testCompletionOnObjectWithNullExpectedTypeSignature() {
        ...
        setUp(CompletionOnMessageSend.class, new UniqueTypeName(JRE_1_6_0, OBJECT), objectType, NO_OBSERVATIONS, null,
                ImmutableList.of(newRecommendation(OBJECT_HASH_CODE, 0.5)));
    ...
    private void setUp(Class<? extends ASTNode> completionType, UniqueTypeName uniqueTypeName, IType receiverType,
        ...
        when(context.get(CompletionContextKey.LOOKUP_ENVIRONMENT)).thenReturn(
                Optional.of(mock(LookupEnvironment.class)));
        when(context.getCompletionNode()).thenReturn(
                completionType == null ? Optional.<ASTNode>absent() : Optional.<ASTNode>of(mock(completionType)));
        ...
        // when(context.get(ENCLOSING_METHOD_FIRST_DECLARATION, null)).thenReturn(overrides);
