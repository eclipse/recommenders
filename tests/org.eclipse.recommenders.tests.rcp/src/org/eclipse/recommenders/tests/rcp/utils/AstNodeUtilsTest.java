...
public class AstNodeUtilsTest {
    ...
    public void testSameSimpleNameOnSimpleTypes() {
        ...
        // test primitive type
        assertTrue(sameSimpleName(ast.newPrimitiveType(PrimitiveType.INT), INT));
        // test array type
        assertTrue(sameSimpleName(ast.newArrayType(newQualifiedType(), 2), VmTypeName.get("[[" + OBJECT)));
    }
