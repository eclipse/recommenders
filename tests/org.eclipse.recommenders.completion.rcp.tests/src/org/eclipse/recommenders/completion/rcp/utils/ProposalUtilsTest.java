...
public class ProposalUtilsTest {
    ...
    public static Collection<Object[]> scenarios() {
        ...
        scenarios.add(scenario("Method With Specified Class Parameter As Argument",
                classbody("Example<T>", "void method(T t) {}"), method("new Example<Number>().method$ "),
                METHOD_OBJECT));
        // scenarios.add(
        ...
        scenarios.add(ignoredScenario("Method With Bounded Class Parameter As Argument",
                classbody("Example<N extends Number>", "void method(N n) {}"), method("new Example().method$ "),
                METHOD_NUMBER));
        scenarios.add(ignoredScenario("Method With Bounded And Specified Class Parameter As Argument",
                ...
                method("new Example<Integer>().method$ "), METHOD_NUMBER));
        scenarios.add(ignoredScenario("Method With Multiple Inheritance Class Parameter As Argument",
                ...
                method("new Example().method$ "), METHOD_NUMBER));
        ...
        scenarios.add(ignoredScenario("", classbody("Example", "void method(Auxiliary a) {}") + auxiliaryDefinition,
        ...
        scenarios.add(scenario("Method With Method Parameter", classbody("Example", "<T> void method(T t) {}"),
                method("new Example().method$ "), METHOD_OBJECT));
        ...
        scenarios.add(scenario("Implicit No Args Constructor", classbody("Example", ""),
                classbody("SubExample extends Example", "void method() { super($) }"), INIT));
        scenarios.add(scenario("Explicit No Args Constructor", classbody("Example", "Example() {}"),
                classbody("SubExample extends Example", "void method() { super($) }"), INIT));
        scenarios.add(scenario("Constructor With Class Parameter Arguement", classbody("Example<T>", "Example(T t) {}"),
                classbody("SubExample extends Example", "void method() { super($) }"), INIT_OBJECT));
        ...
        scenarios.add(ignoredScenario("Constructor With Bounded Class Parameter Argument",
                ...
                classbody("SubExample extends Example", "void method() { super($) }"), INIT_NUMBER));
        scenarios.add(scenario("Constructor With Wildcard Parameterized Argument Extending Class Parameter",
                ...
                classbody("SubExample extends Example", "void method() { super($) }"), INIT_COLLECTION));
        ...
        scenarios.add(scenario("Static Nested Class Constructor",
                ...
                method("new Example.Nested$ "), NESTED_INIT));
        scenarios.add(scenario("Static Nested Parameterized Class Constructor",
                classbody("Example", "static class Nested<T> { Nested(T t) {} }"), method("new Example.Nested$ "),
                NESTED_INIT_OBJECT));
        scenarios.add(scenario("Static Nested Object Bounded Parameterized Class Constructor",
                ...
                method("new Example.Nested$ "), NESTED_INIT_OBJECT));
        scenarios.add(ignoredScenario("Static Nested Bounded Parameterized Class Constructor",
                ...
                method("new Example.Nested$ "), NESTED_INIT_NUMBER));
        scenarios.add(scenario(
                ...
                method("new Example.Nested$ "), NESTED_INIT_COLLECTION));

        // scenarios.add(ignoredScenario(classbody("Example", "class Inner { Inner() { new Example.Inner$ } }"),
        // INNER_INIT_EXAMPLE));
        scenarios.add(scenario("", classbody("Example", "class Inner { Inner() {} }"),
                method("new Example().new Inner$"), INNER_INIT_EXAMPLE));
