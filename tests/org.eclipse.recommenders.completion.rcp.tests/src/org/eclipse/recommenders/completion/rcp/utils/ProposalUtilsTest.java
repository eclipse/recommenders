...
public class ProposalUtilsTest {
    ...
    public static Collection<Object[]> scenarios() {
        ...
        scenarios.add(scenario("Method with no arguments",
                ...
                METHOD_VOID));
        scenarios.add(scenario("Method with argument: Object",
                classbody("Example", "public void method(Object o) {}"),
                method("new Example().method$"),
                METHOD_OBJECT));
        scenarios.add(scenario("Method with argument: int[]",
        ...
        scenarios.add(scenario("Method with Argument: Object[]",
                ...
                method("new Example().method$"),
                METHOD_OBJECTS));
        scenarios.add(scenario("Method with argument: Collection",
                classbody("Example", "public void method(Collection c) {}"),
                method("new Example().method$"),
                METHOD_COLLECTION));
        scenarios.add(scenario("Method with argument: Collection<Number>",
        ...
        scenarios.add(scenario("Method with argument: Collection<?>",
                ...
                method("new Example().method$"),
                METHOD_COLLECTION));
        scenarios.add(scenario("Method with argument: Collection<? extends Number>",
                classbody("Example", "public void method(Collection<? extends Number> c) {}"),
                method("new Example().method$"),
                METHOD_COLLECTION));
        scenarios.add(scenario("Method with argument: Collection<? super Number>",
        ...
        scenarios.add(scenario("Generic method with parameter: O extends Object",
                ...
                method("new Example().method$"),
                METHOD_OBJECT));
        scenarios.add(scenario("Generic method with parameter: N extends Number",
                classbody("Example", "public <N extends Number> void method(N n) {}"),
                method("new Example().method$"),
                METHOD_NUMBER));
        scenarios.add(scenario("Generic method with parameter: N extends Number & Comparable",
        ...
        scenarios.add(scenario("Parameterized static method with parameter: O extends Object",
                ...
                method("Example.<Integer>method$"),
                METHOD_OBJECT));
        scenarios.add(scenario("Parameterized static method with parameter: N extends Number",
                classbody("Example", "public static <N extends Number> void method(N n) {}"),
                method("Example.<Integer>method$"),
                METHOD_NUMBER));
        scenarios.add(scenario("Parameterized static method with parameter: N extends Number & Comparable",
