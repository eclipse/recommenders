...
public class ProposalUtilsTest {
    ...
    public static Collection<Object[]> scenarios() {
        ...
        scenarios.add(scenario("Method With Parameterized Type of Class As Argument",
        ...
        scenarios.add(scenario("Method With Bounded Above Parameterized Type of Class As Argument",
        ...
        scenarios.add(scenario("", classbody("Example<L extends List<String>>", "L l;"),
                method("new Example().l.set$ "), SET_INT_STRING));
    ...
    public void testSourceBindings() throws Exception {
        ...
        TemporaryProject dependency = ws.createProject();
