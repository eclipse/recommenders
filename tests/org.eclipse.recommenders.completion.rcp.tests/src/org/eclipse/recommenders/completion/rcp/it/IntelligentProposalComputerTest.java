...
import org.eclipse.recommenders.completion.rcp.processable.IntelligentCompletionProposalComputer.EditorPartRetriever;
...
public class IntelligentProposalComputerTest {
    ...
    public IntelligentCompletionProposalComputer createSUT() {
        return createSUT(new EditorPartRetriever());
    }

    public IntelligentCompletionProposalComputer createSUT(EditorPartRetriever retriever) {
        ...
        return new IntelligentCompletionProposalComputer(preferences, new CachingAstProvider(), new SharedImages(),
                CompletionContextFunctions.defaultFunctions(), retriever);
    }
    ...
    public void testSubClassOfCompilationUnitEditor() {
        ...
        CompilationUnitEditor anonymousCUEditor = new CompilationUnitEditor() {
        };
        EditorPartRetriever retriever = mock(EditorPartRetriever.class);
        when(retriever.getEditor()).thenReturn((IEditorPart) anonymousCUEditor);
