...
import org.eclipse.recommenders.internal.subwords.rcp.DisableSubwordsCompletionProposal;
...
public class Bug425994Test {
    ...
    public static Collection<Object[]> proposals() {
        ...
        proposals.add(new Object[] { new DisableSubwordsCompletionProposal(images, null) });
